...
$c_Ljapgolly_scalajs_react_CtorType$Summoner$.prototype.summonN__Ljapgolly_scalajs_react_internal_Singleton__Ljapgolly_scalajs_react_CtorType$Summoner = (function(s) {
  var f = new $c_sjsr_AnonFunction1(((rc) => new $c_Ljapgolly_scalajs_react_CtorType$Nullary($i_react.createElement(rc, $n(s).Ljapgolly_scalajs_react_internal_Singleton__f_value), new $c_sjsr_AnonFunction1(((m) => {
...
function $c_Ljapgolly_scalajs_react_callback_AsyncCallback$() {
  ...
  new $c_Ljapgolly_scalajs_react_callback_CallbackTo(($m_Ljapgolly_scalajs_react_callback_Trampoline$(), new $c_Ljapgolly_scalajs_react_callback_Trampoline$Delay(f$proxy3)));
...
$c_Ljapgolly_scalajs_react_callback_AsyncCallback$.prototype.pure__O__F1 = (function(a) {
  ...
  return $m_Ljapgolly_scalajs_react_callback_AsyncCallback$().apply__F1__F1(new $c_sjsr_AnonFunction1(((_$8) => {
    var _$8$1 = $as_F1(_$8);
    var ev$83 = $n(_$8$1).apply__O__O(t$proxy1);
    return new $c_Ljapgolly_scalajs_react_callback_CallbackTo(((ev$83 === null) ? null : $n($as_Ljapgolly_scalajs_react_callback_CallbackTo(ev$83)).Ljapgolly_scalajs_react_callback_CallbackTo__f_trampoline));
  })));
});
...
$c_Ljapgolly_scalajs_react_callback_CallbackTo.prototype.equals__O__Z = (function(x$0) {
  return $m_Ljapgolly_scalajs_react_callback_CallbackTo$().equals$extension__Ljapgolly_scalajs_react_callback_Trampoline__O__Z(this.Ljapgolly_scalajs_react_callback_CallbackTo__f_trampoline, x$0);
});
...
$h_Ljapgolly_scalajs_react_callback_CallbackTo$.prototype = $c_Ljapgolly_scalajs_react_callback_CallbackTo$.prototype;
$c_Ljapgolly_scalajs_react_callback_CallbackTo$.prototype.equals$extension__Ljapgolly_scalajs_react_callback_Trampoline__O__Z = (function(this$, x$0) {
...
var $d_Ljapgolly_scalajs_react_callback_Trampoline$ = new $TypeData().initClass($c_Ljapgolly_scalajs_react_callback_Trampoline$, "japgolly.scalajs.react.callback.Trampoline$", ({
...
function $p_Ljapgolly_scalajs_react_component_ScalaFn$__create__F1__Ljapgolly_scalajs_react_CtorType$Summoner__Ljapgolly_scalajs_react_component_JsBaseComponentTemplate$ComponentWithRoot($thiz, render, s) {
  var jsRender = $m_sjs_js_Any$().fromFunction1__F1__sjs_js_Function1($n(render).andThen__F1__F1(new $c_sjsr_AnonFunction1(((_$1) => {
    var _$1$1 = $as_Ljapgolly_scalajs_react_vdom_VdomNode(_$1);
    return $n(_$1$1).rawNode__O();
  }))));
  return $n($n($m_Ljapgolly_scalajs_react_component_JsFn$().force__O__Ljapgolly_scalajs_react_CtorType$Summoner__Ljapgolly_scalajs_react_component_JsBaseComponentTemplate$ComponentWithRoot(jsRender, s)).cmapCtorProps__F1__Ljapgolly_scalajs_react_component_JsBaseComponentTemplate$ComponentWithRoot(new $c_sjsr_AnonFunction1(((_$2) => {
    ...
    return $n(_$3$1).mapUnmountedProps__F1__Ljapgolly_scalajs_react_component_JsFn$UnmountedWithRoot(new $c_sjsr_AnonFunction1(((_$4) => _$4.a)));
  })));
}
/** @constructor */
...
$c_Ljapgolly_scalajs_react_component_ScalaFn$.prototype.apply__F1__Ljapgolly_scalajs_react_CtorType$Summoner__Ljapgolly_scalajs_react_component_JsBaseComponentTemplate$ComponentWithRoot = (function(render, s) {
  return $p_Ljapgolly_scalajs_react_component_ScalaFn$__create__F1__Ljapgolly_scalajs_react_CtorType$Summoner__Ljapgolly_scalajs_react_component_JsBaseComponentTemplate$ComponentWithRoot(this, new $c_sjsr_AnonFunction1(((b) => $as_Ljapgolly_scalajs_react_vdom_VdomNode($n(render).apply__O__O(b.a)))), s);
});
...
function $p_Ljapgolly_scalajs_react_util_JsUtil$__liftedTree1$1__sjs_js_Dynamic__T__O($thiz, d$2, n$1) {
  try {
    return d$2[n$1];
  } catch (e) {
    var e$1 = e;
    var e$2 = ((e$1 instanceof $c_jl_Throwable) ? e$1 : new $c_sjs_js_JavaScriptException(e$1));
    return $thiz.safeToString__O__T(e$2);
  }
}
/** @constructor */
function $c_Ljapgolly_scalajs_react_util_JsUtil$() {
}
$c_Ljapgolly_scalajs_react_util_JsUtil$.prototype = new $h_O();
$c_Ljapgolly_scalajs_react_util_JsUtil$.prototype.constructor = $c_Ljapgolly_scalajs_react_util_JsUtil$;
/** @constructor */
function $h_Ljapgolly_scalajs_react_util_JsUtil$() {
}
$h_Ljapgolly_scalajs_react_util_JsUtil$.prototype = $c_Ljapgolly_scalajs_react_util_JsUtil$.prototype;
$c_Ljapgolly_scalajs_react_util_JsUtil$.prototype.safeToString__O__T = (function(a) {
  try {
    if ((a !== null)) {
      var x3 = $m_Ljapgolly_scalajs_react_util_JsUtil$JsSymbol$().unapply__O__s_Option(a);
      if ((!$n(x3).isEmpty__Z())) {
        var x4 = $n(x3).get__O();
        return this.symbolToString__sjs_js_Symbol__T(x4);
      }
    }
    return $dp_toString__T($n(a));
  } catch (e) {
    return "?";
  }
});
$c_Ljapgolly_scalajs_react_util_JsUtil$.prototype.symbolToString__sjs_js_Symbol__T = (function(s) {
  try {
    return $as_T(s.toString());
  } catch (e) {
    var x = Symbol.keyFor(s);
    var x6 = ((x === (void 0)) ? $m_s_None$() : new $c_s_Some(x));
    if ((x6 instanceof $c_s_Some)) {
      var k = $as_T($n($as_s_Some(x6)).s_Some__f_value);
      return (("Symbol(" + k) + ")");
    }
    var x$1 = $m_s_None$();
    if ((x$1 === x6)) {
...
$c_Ljapgolly_scalajs_react_util_JsUtil$.prototype.objectIterator__sjs_js_Object__sc_Iterator = (function(o) {
  var $x_1 = $m_sjs_js_Any$ObjectCompanionOps$();
  var self = Object;
  var array = $n($x_1).properties$extension__sjs_js_Object$__sjs_js_Any__sjs_js_Array(self, o);
  var this$7 = new $c_sjs_js_ArrayOps$ArrayIterator(array);
  var f = new $c_sjsr_AnonFunction1(((n) => {
    var n$1 = $as_T(n);
    var v = $p_Ljapgolly_scalajs_react_util_JsUtil$__liftedTree1$1__sjs_js_Dynamic__T__O(this, o, n$1);
    return new $c_T2(n$1, v);
  }));
  return new $c_sc_Iterator$$anon$9(this$7, f);
});
var $d_Ljapgolly_scalajs_react_util_JsUtil$ = new $TypeData().initClass($c_Ljapgolly_scalajs_react_util_JsUtil$, "japgolly.scalajs.react.util.JsUtil$", ({
  Ljapgolly_scalajs_react_util_JsUtil$: 1
}));
var $n_Ljapgolly_scalajs_react_util_JsUtil$;
function $m_Ljapgolly_scalajs_react_util_JsUtil$() {
  if ((!$n_Ljapgolly_scalajs_react_util_JsUtil$)) {
    $n_Ljapgolly_scalajs_react_util_JsUtil$ = new $c_Ljapgolly_scalajs_react_util_JsUtil$();
  }
  return $n_Ljapgolly_scalajs_react_util_JsUtil$;
}
/** @constructor */
function $c_Ljapgolly_scalajs_react_util_JsUtil$JsSymbol$() {
}
$c_Ljapgolly_scalajs_react_util_JsUtil$JsSymbol$.prototype = new $h_O();
$c_Ljapgolly_scalajs_react_util_JsUtil$JsSymbol$.prototype.constructor = $c_Ljapgolly_scalajs_react_util_JsUtil$JsSymbol$;
/** @constructor */
function $h_Ljapgolly_scalajs_react_util_JsUtil$JsSymbol$() {
}
$h_Ljapgolly_scalajs_react_util_JsUtil$JsSymbol$.prototype = $c_Ljapgolly_scalajs_react_util_JsUtil$JsSymbol$.prototype;
$c_Ljapgolly_scalajs_react_util_JsUtil$JsSymbol$.prototype.unapply__O__s_Option = (function(a) {
...
var $d_Ljapgolly_scalajs_react_util_JsUtil$JsSymbol$ = new $TypeData().initClass($c_Ljapgolly_scalajs_react_util_JsUtil$JsSymbol$, "japgolly.scalajs.react.util.JsUtil$JsSymbol$", ({
  Ljapgolly_scalajs_react_util_JsUtil$JsSymbol$: 1
}));
var $n_Ljapgolly_scalajs_react_util_JsUtil$JsSymbol$;
function $m_Ljapgolly_scalajs_react_util_JsUtil$JsSymbol$() {
  if ((!$n_Ljapgolly_scalajs_react_util_JsUtil$JsSymbol$)) {
    $n_Ljapgolly_scalajs_react_util_JsUtil$JsSymbol$ = new $c_Ljapgolly_scalajs_react_util_JsUtil$JsSymbol$();
  }
  return $n_Ljapgolly_scalajs_react_util_JsUtil$JsSymbol$;
}
/** @constructor */
...
$c_Ljapgolly_scalajs_react_vdom_Attr$ValueType$.prototype.apply$extension__F2__T__O__Ljapgolly_scalajs_react_vdom_TagMod = (function(this$, name, value) {
  var f = new $c_sjsr_AnonFunction1(((b) => {
    var b$1 = $as_Ljapgolly_scalajs_react_vdom_VdomBuilder(b);
    $n(this$).apply__O__O__O(new $c_sjsr_AnonFunction1(((_$9) => {
      $n($n(b$1).Ljapgolly_scalajs_react_vdom_VdomBuilder$ToRawReactElement__f_addAttr).apply__O__O__O(name, _$9);
    })), value);
  }));
...
function $ct_Ljapgolly_scalajs_react_vdom_Exports__($thiz) {
  $thiz.Ljapgolly_scalajs_react_vdom_Exports__f_EmptyVdom = $m_Ljapgolly_scalajs_react_vdom_VdomNode$().Ljapgolly_scalajs_react_vdom_VdomNode$__f_empty;
...
function $c_Ljapgolly_scalajs_react_vdom_Exports() {
  this.Ljapgolly_scalajs_react_vdom_Exports__f_EmptyVdom = null;
...
function $f_Ljapgolly_scalajs_react_vdom_HtmlAttrs__$init$__V($thiz) {
  $thiz.Ljapgolly_scalajs_react_vdom_HtmlAttrAndStyles$__f_key = ($m_Ljapgolly_scalajs_react_vdom_PackageBase$(), $m_Ljapgolly_scalajs_react_vdom_Attr$Key$());
}
function $f_Ljapgolly_scalajs_react_vdom_TagLite__apply__T__sci_Seq__Ljapgolly_scalajs_react_vdom_TagOf($thiz, self, xs) {
  ...
  return $ct_Ljapgolly_scalajs_react_vdom_TagOf__T__sci_List__(new $c_Ljapgolly_scalajs_react_vdom_TagOf(), self, new $c_sci_$colon$colon(xs, this$1));
}
...
$c_Ljapgolly_scalajs_react_vdom_VdomArray$.prototype.empty__Ljapgolly_scalajs_react_vdom_VdomArray = (function() {
  return new $c_Ljapgolly_scalajs_react_vdom_VdomArray([]);
});
var $d_Ljapgolly_scalajs_react_vdom_VdomArray$ = new $TypeData().initClass($c_Ljapgolly_scalajs_react_vdom_VdomArray$, "japgolly.scalajs.react.vdom.VdomArray$", ({
  Ljapgolly_scalajs_react_vdom_VdomArray$: 1
}));
var $n_Ljapgolly_scalajs_react_vdom_VdomArray$;
function $m_Ljapgolly_scalajs_react_vdom_VdomArray$() {
  if ((!$n_Ljapgolly_scalajs_react_vdom_VdomArray$)) {
    $n_Ljapgolly_scalajs_react_vdom_VdomArray$ = new $c_Ljapgolly_scalajs_react_vdom_VdomArray$();
  }
  return $n_Ljapgolly_scalajs_react_vdom_VdomArray$;
}
function $f_Ljapgolly_scalajs_react_vdom_VdomBuilder__addStyles__sjs_js_Any__V($thiz, j) {
  $n($thiz.Ljapgolly_scalajs_react_vdom_VdomBuilder$ToRawReactElement__f_addStylesObject).apply__O__O(j);
}
...
function $c_Ljapgolly_scalajs_react_vdom_VdomBuilder$ToRawReactElement$() {
  ...
  this.Ljapgolly_scalajs_react_vdom_VdomBuilder$ToRawReactElement$__f_build = new $c_sjsr_AnonFunction4(((tag, props, key, children) => {
    var tag$1 = $as_T(tag);
    if ((key !== (void 0))) {
      props.key = key;
    }
...
function $s_Llanding_Main__main__AT__V(args) {
  $m_Llanding_Main$().main__AT__V(args);
}
/** @constructor */
function $c_Llanding_Main$() {
  this.Llanding_Main$__f_githubUrl = null;
  this.Llanding_Main$__f_pink = null;
  this.Llanding_Main$__f_purple = null;
  this.Llanding_Main$__f_navGlassStyle = null;
  this.Llanding_Main$__f_Navbar = null;
  this.Llanding_Main$__f_Hero = null;
  this.Llanding_Main$__f_pipelineSteps = null;
  this.Llanding_Main$__f_Pipeline = null;
  this.Llanding_Main$__f_codeExample = null;
  this.Llanding_Main$__f_CodeBlock = null;
  this.Llanding_Main$__f_featureList = null;
  this.Llanding_Main$__f_Features = null;
  this.Llanding_Main$__f_Footer = null;
  this.Llanding_Main$__f_App = null;
  $n_Llanding_Main$ = this;
  this.Llanding_Main$__f_githubUrl = "https://github.com/aathoos/aathu-lang";
  this.Llanding_Main$__f_pink = "#FF1361";
  this.Llanding_Main$__f_purple = "#44107A";
  var fields = $m_sr_ScalaRunTime$().wrapRefArray__AO__sci_ArraySeq(new ($d_T2.getArrayOf().constr)([new $c_T2("background", "rgba(255, 255, 255, 0.82)"), new $c_T2("backdropFilter", "blur(10px)"), new $c_T2("WebkitBackdropFilter", "blur(10px)"), new $c_T2("borderBottom", "1px solid rgba(229, 231, 235, 0.7)")]));
  this.Llanding_Main$__f_navGlassStyle = $m_sjs_js_special_package$().objectLiteral__sci_Seq__sjs_js_Object(fields);
  this.Llanding_Main$__f_Navbar = $n($m_Ljapgolly_scalajs_react_package$().Ljapgolly_scalajs_react_internal_CoreGeneralF__f_ScalaFnComponent).apply__F1__Ljapgolly_scalajs_react_CtorType$Summoner__Ljapgolly_scalajs_react_component_JsBaseComponentTemplate$ComponentWithRoot(new $c_sjsr_AnonFunction1(((_$1) => {
    $as_jl_Void(_$1);
    var this$55 = $m_Ljapgolly_scalajs_react_vdom_HtmlTagOf$();
    ...
    var $x_26 = ($n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$up), $m_Ljapgolly_scalajs_react_vdom_Attr$ClassName$()).$colon$eq__O__F2__Ljapgolly_scalajs_react_vdom_TagMod("w-full sticky top-0 z-50", $m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_PackageBase__f_vdomAttrVtString);
    var $x_25 = ($n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$up), $m_Ljapgolly_scalajs_react_vdom_Attr$Style$()).$colon$eq__O__F2__Ljapgolly_scalajs_react_vdom_TagMod(this.Llanding_Main$__f_navGlassStyle, $m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_PackageBase__f_vdomAttrVtJsObject);
    var this$54 = $m_Ljapgolly_scalajs_react_vdom_HtmlTagOf$();
    $n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$less);
    $n($m_Ljapgolly_scalajs_react_vdom_Exports$().Ljapgolly_scalajs_react_vdom_Exports__f_HtmlTagOf);
    var self$1 = "div";
    var $x_24 = $m_sr_ScalaRunTime$();
    var $x_23 = ($n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$up), $m_Ljapgolly_scalajs_react_vdom_Attr$ClassName$()).$colon$eq__O__F2__Ljapgolly_scalajs_react_vdom_TagMod("max-w-6xl mx-auto px-8 h-16 flex items-center justify-between", $m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_PackageBase__f_vdomAttrVtString);
    var $x_22 = $n($n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$less).a__Ljapgolly_scalajs_react_vdom_HtmlTags$a$());
    ...
    var this$19 = $ct_Ljapgolly_scalajs_react_vdom_Attr$Generic__T__(new $c_Ljapgolly_scalajs_react_vdom_Attr$Generic(), "href");
    var t = $m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_PackageBase__f_vdomAttrVtString;
    var $x_20 = $n($x_22).apply__sci_Seq__Ljapgolly_scalajs_react_vdom_TagOf($n($x_21).wrapRefArray__AO__sci_ArraySeq(new ($d_Ljapgolly_scalajs_react_vdom_TagMod.getArrayOf().constr)([$m_Ljapgolly_scalajs_react_vdom_Attr$ValueType$().apply$extension__F2__T__O__Ljapgolly_scalajs_react_vdom_TagMod(t, this$19.Ljapgolly_scalajs_react_vdom_Attr__f_attrName, "/"), ($n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$up), $m_Ljapgolly_scalajs_react_vdom_Attr$ClassName$()).$colon$eq__O__F2__Ljapgolly_scalajs_react_vdom_TagMod("gradient-text font-mono font-bold text-xl", $m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_PackageBase__f_vdomAttrVtString), ($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$(), $m_Ljapgolly_scalajs_react_vdom_VdomNode$(), new $c_Ljapgolly_scalajs_react_vdom_VdomNode$$anon$1("aathu"))])));
    var this$53 = $m_Ljapgolly_scalajs_react_vdom_HtmlTagOf$();
    $n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$less);
    $n($m_Ljapgolly_scalajs_react_vdom_Exports$().Ljapgolly_scalajs_react_vdom_Exports__f_HtmlTagOf);
    var self = "div";
    var $x_19 = $m_sr_ScalaRunTime$();
    var $x_18 = ($n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$up), $m_Ljapgolly_scalajs_react_vdom_Attr$ClassName$()).$colon$eq__O__F2__Ljapgolly_scalajs_react_vdom_TagMod("flex items-center gap-7", $m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_PackageBase__f_vdomAttrVtString);
    var $x_17 = $n($n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$less).a__Ljapgolly_scalajs_react_vdom_HtmlTags$a$());
    var $x_16 = $m_sr_ScalaRunTime$();
    $n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$up);
    var this$27 = $ct_Ljapgolly_scalajs_react_vdom_Attr$Generic__T__(new $c_Ljapgolly_scalajs_react_vdom_Attr$Generic(), "href");
    var t$1 = $m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_PackageBase__f_vdomAttrVtString;
    var $x_15 = $n($x_17).apply__sci_Seq__Ljapgolly_scalajs_react_vdom_TagOf($n($x_16).wrapRefArray__AO__sci_ArraySeq(new ($d_Ljapgolly_scalajs_react_vdom_TagMod.getArrayOf().constr)([$m_Ljapgolly_scalajs_react_vdom_Attr$ValueType$().apply$extension__F2__T__O__Ljapgolly_scalajs_react_vdom_TagMod(t$1, this$27.Ljapgolly_scalajs_react_vdom_Attr__f_attrName, "#"), ($n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$up), $m_Ljapgolly_scalajs_react_vdom_Attr$ClassName$()).$colon$eq__O__F2__Ljapgolly_scalajs_react_vdom_TagMod("text-sm text-gray-600 hover:text-gray-900", $m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_PackageBase__f_vdomAttrVtString), ($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$(), $m_Ljapgolly_scalajs_react_vdom_VdomNode$(), new $c_Ljapgolly_scalajs_react_vdom_VdomNode$$anon$1("Docs"))])));
    var $x_14 = $n($n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$less).a__Ljapgolly_scalajs_react_vdom_HtmlTags$a$());
    var $x_13 = $m_sr_ScalaRunTime$();
    $n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$up);
    var this$32 = $ct_Ljapgolly_scalajs_react_vdom_Attr$Generic__T__(new $c_Ljapgolly_scalajs_react_vdom_Attr$Generic(), "href");
    var t$2 = $m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_PackageBase__f_vdomAttrVtString;
    var $x_12 = $n($x_14).apply__sci_Seq__Ljapgolly_scalajs_react_vdom_TagOf($n($x_13).wrapRefArray__AO__sci_ArraySeq(new ($d_Ljapgolly_scalajs_react_vdom_TagMod.getArrayOf().constr)([$m_Ljapgolly_scalajs_react_vdom_Attr$ValueType$().apply$extension__F2__T__O__Ljapgolly_scalajs_react_vdom_TagMod(t$2, this$32.Ljapgolly_scalajs_react_vdom_Attr__f_attrName, "#"), ($n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$up), $m_Ljapgolly_scalajs_react_vdom_Attr$ClassName$()).$colon$eq__O__F2__Ljapgolly_scalajs_react_vdom_TagMod("text-sm text-gray-600 hover:text-gray-900", $m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_PackageBase__f_vdomAttrVtString), ($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$(), $m_Ljapgolly_scalajs_react_vdom_VdomNode$(), new $c_Ljapgolly_scalajs_react_vdom_VdomNode$$anon$1("Examples"))])));
    var $x_11 = $n($n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$less).a__Ljapgolly_scalajs_react_vdom_HtmlTags$a$());
    var $x_10 = $m_sr_ScalaRunTime$();
    $n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$up);
    var this$37 = $ct_Ljapgolly_scalajs_react_vdom_Attr$Generic__T__(new $c_Ljapgolly_scalajs_react_vdom_Attr$Generic(), "href");
    var t$3 = $m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_PackageBase__f_vdomAttrVtString;
    var $x_9 = $n($x_11).apply__sci_Seq__Ljapgolly_scalajs_react_vdom_TagOf($n($x_10).wrapRefArray__AO__sci_ArraySeq(new ($d_Ljapgolly_scalajs_react_vdom_TagMod.getArrayOf().constr)([$m_Ljapgolly_scalajs_react_vdom_Attr$ValueType$().apply$extension__F2__T__O__Ljapgolly_scalajs_react_vdom_TagMod(t$3, this$37.Ljapgolly_scalajs_react_vdom_Attr__f_attrName, "#"), ($n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$up), $m_Ljapgolly_scalajs_react_vdom_Attr$ClassName$()).$colon$eq__O__F2__Ljapgolly_scalajs_react_vdom_TagMod("text-sm text-gray-600 hover:text-gray-900", $m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_PackageBase__f_vdomAttrVtString), ($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$(), $m_Ljapgolly_scalajs_react_vdom_VdomNode$(), new $c_Ljapgolly_scalajs_react_vdom_VdomNode$$anon$1("Changelog"))])));
    var $x_8 = $n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$less).a__Ljapgolly_scalajs_react_vdom_HtmlTags$a$();
    var $x_7 = $m_sr_ScalaRunTime$();
    $n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$up);
    var this$42 = $ct_Ljapgolly_scalajs_react_vdom_Attr$Generic__T__(new $c_Ljapgolly_scalajs_react_vdom_Attr$Generic(), "href");
    var a = this.Llanding_Main$__f_githubUrl;
    var t$4 = $m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_PackageBase__f_vdomAttrVtString;
    var $x_6 = $m_Ljapgolly_scalajs_react_vdom_Attr$ValueType$().apply$extension__F2__T__O__Ljapgolly_scalajs_react_vdom_TagMod(t$4, this$42.Ljapgolly_scalajs_react_vdom_Attr__f_attrName, a);
    var this$43 = $n($n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$up).target__Ljapgolly_scalajs_react_vdom_HtmlAttrs$target$());
    var t$5 = $m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_PackageBase__f_vdomAttrVtString;
    var $x_5 = $m_Ljapgolly_scalajs_react_vdom_Attr$ValueType$().apply$extension__F2__T__O__Ljapgolly_scalajs_react_vdom_TagMod(t$5, this$43.Ljapgolly_scalajs_react_vdom_Attr__f_attrName, "_blank");
    $n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$up);
    var this$45 = $ct_Ljapgolly_scalajs_react_vdom_Attr$Generic__T__(new $c_Ljapgolly_scalajs_react_vdom_Attr$Generic(), "rel");
    var t$6 = $m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_PackageBase__f_vdomAttrVtString;
    var $x_4 = $m_Ljapgolly_scalajs_react_vdom_Attr$ValueType$().apply$extension__F2__T__O__Ljapgolly_scalajs_react_vdom_TagMod(t$6, this$45.Ljapgolly_scalajs_react_vdom_Attr__f_attrName, "noopener noreferrer");
    var $x_3 = ($n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$up), $m_Ljapgolly_scalajs_react_vdom_Attr$ClassName$()).$colon$eq__O__F2__Ljapgolly_scalajs_react_vdom_TagMod("text-sm font-medium text-white px-4 py-2 rounded-md", $m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_PackageBase__f_vdomAttrVtString);
    $n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$up);
    var $x_2 = $m_Ljapgolly_scalajs_react_vdom_Attr$Style$();
    var $x_1 = $m_sr_ScalaRunTime$();
    var s = this.Llanding_Main$__f_pink;
    var fields$1 = $n($x_1).wrapRefArray__AO__sci_ArraySeq(new ($d_T2.getArrayOf().constr)([new $c_T2("background", s)]));
    var xs = $n($x_19).wrapRefArray__AO__sci_ArraySeq(new ($d_Ljapgolly_scalajs_react_vdom_TagMod.getArrayOf().constr)([$x_18, $x_15, $x_12, $x_9, $n($x_8).apply__sci_Seq__Ljapgolly_scalajs_react_vdom_TagOf($n($x_7).wrapRefArray__AO__sci_ArraySeq(new ($d_Ljapgolly_scalajs_react_vdom_TagMod.getArrayOf().constr)([$x_6, $x_5, $x_4, $x_3, $x_2.$colon$eq__O__F2__Ljapgolly_scalajs_react_vdom_TagMod($m_sjs_js_special_package$().objectLiteral__sci_Seq__sjs_js_Object(fields$1), $m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_PackageBase__f_vdomAttrVtJsObject), ($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$(), $m_Ljapgolly_scalajs_react_vdom_VdomNode$(), new $c_Ljapgolly_scalajs_react_vdom_VdomNode$$anon$1("GitHub \u2197"))])))]));
    var xs$1 = $n($x_24).wrapRefArray__AO__sci_ArraySeq(new ($d_Ljapgolly_scalajs_react_vdom_TagMod.getArrayOf().constr)([$x_23, $x_20, $f_Ljapgolly_scalajs_react_vdom_TagLite__apply__T__sci_Seq__Ljapgolly_scalajs_react_vdom_TagOf(this$53, self, xs)]));
    var xs$2 = $n($x_27).wrapRefArray__AO__sci_ArraySeq(new ($d_Ljapgolly_scalajs_react_vdom_TagMod.getArrayOf().constr)([$x_26, $x_25, $f_Ljapgolly_scalajs_react_vdom_TagLite__apply__T__sci_Seq__Ljapgolly_scalajs_react_vdom_TagOf(this$54, self$1, xs$1)]));
    return $f_Ljapgolly_scalajs_react_vdom_TagLite__apply__T__sci_Seq__Ljapgolly_scalajs_react_vdom_TagOf(this$55, self$2, xs$2);
  ...
  this.Llanding_Main$__f_Hero = $n($m_Ljapgolly_scalajs_react_package$().Ljapgolly_scalajs_react_internal_CoreGeneralF__f_ScalaFnComponent).apply__F1__Ljapgolly_scalajs_react_CtorType$Summoner__Ljapgolly_scalajs_react_component_JsBaseComponentTemplate$ComponentWithRoot(new $c_sjsr_AnonFunction1(((_$2) => {
    $as_jl_Void(_$2);
    var this$107 = $m_Ljapgolly_scalajs_react_vdom_HtmlTagOf$();
    $n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$less);
    $n($m_Ljapgolly_scalajs_react_vdom_Exports$().Ljapgolly_scalajs_react_vdom_Exports__f_HtmlTagOf);
    var self$8 = "section";
    var $x_48 = $m_sr_ScalaRunTime$();
    var $x_47 = ($n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$up), $m_Ljapgolly_scalajs_react_vdom_Attr$ClassName$()).$colon$eq__O__F2__Ljapgolly_scalajs_react_vdom_TagMod("max-w-6xl mx-auto px-8 pt-24 pb-20", $m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_PackageBase__f_vdomAttrVtString);
    var this$72 = $m_Ljapgolly_scalajs_react_vdom_HtmlTagOf$();
    $n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$less);
    $n($m_Ljapgolly_scalajs_react_vdom_Exports$().Ljapgolly_scalajs_react_vdom_Exports__f_HtmlTagOf);
    var self$3 = "div";
    var $x_45 = $m_sr_ScalaRunTime$();
    var $x_44 = ($n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$up), $m_Ljapgolly_scalajs_react_vdom_Attr$ClassName$()).$colon$eq__O__F2__Ljapgolly_scalajs_react_vdom_TagMod("inline-flex items-center gap-2 text-xs font-mono px-3 py-1 rounded-full mb-8 border", $m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_PackageBase__f_vdomAttrVtString);
    $n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$up);
    var $x_43 = $m_Ljapgolly_scalajs_react_vdom_Attr$Style$();
    var $x_42 = $m_sr_ScalaRunTime$();
    var s$1 = this.Llanding_Main$__f_purple;
    var fields$2 = $n($x_42).wrapRefArray__AO__sci_ArraySeq(new ($d_T2.getArrayOf().constr)([new $c_T2("color", s$1), new $c_T2("borderColor", "#e9d5ff"), new $c_T2("backgroundColor", "#faf5ff")]));
    var xs$3 = $n($x_45).wrapRefArray__AO__sci_ArraySeq(new ($d_Ljapgolly_scalajs_react_vdom_TagMod.getArrayOf().constr)([$x_44, $x_43.$colon$eq__O__F2__Ljapgolly_scalajs_react_vdom_TagMod($m_sjs_js_special_package$().objectLiteral__sci_Seq__sjs_js_Object(fields$2), $m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_PackageBase__f_vdomAttrVtJsObject), ($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$(), $m_Ljapgolly_scalajs_react_vdom_VdomNode$(), new $c_Ljapgolly_scalajs_react_vdom_VdomNode$$anon$1("Written in Rust \u00b7 Open Source \u00b7 Early Development"))]));
    var $x_46 = $f_Ljapgolly_scalajs_react_vdom_TagLite__apply__T__sci_Seq__Ljapgolly_scalajs_react_vdom_TagOf(this$72, self$3, xs$3);
    var this$83 = $m_Ljapgolly_scalajs_react_vdom_HtmlTagOf$();
    $n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$less);
    $n($m_Ljapgolly_scalajs_react_vdom_Exports$().Ljapgolly_scalajs_react_vdom_Exports__f_HtmlTagOf);
    var self$5 = "h1";
    var $x_40 = $m_sr_ScalaRunTime$();
    var $x_39 = ($n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$up), $m_Ljapgolly_scalajs_react_vdom_Attr$ClassName$()).$colon$eq__O__F2__Ljapgolly_scalajs_react_vdom_TagMod("text-6xl font-bold tracking-tight text-gray-900 leading-tight mb-6", $m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_PackageBase__f_vdomAttrVtString);
    $m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$();
    $m_Ljapgolly_scalajs_react_vdom_VdomNode$();
    var $x_38 = new $c_Ljapgolly_scalajs_react_vdom_VdomNode$$anon$1("A compiled language");
    var this$80 = $m_Ljapgolly_scalajs_react_vdom_HtmlTagOf$();
    $n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$less);
    var self$4 = "br";
    var xs$4 = $m_sr_ScalaRunTime$().wrapRefArray__AO__sci_ArraySeq(new ($d_Ljapgolly_scalajs_react_vdom_TagMod.getArrayOf().constr)([]));
    var xs$5 = $n($x_40).wrapRefArray__AO__sci_ArraySeq(new ($d_Ljapgolly_scalajs_react_vdom_TagMod.getArrayOf().constr)([$x_39, $x_38, $f_Ljapgolly_scalajs_react_vdom_TagLite__apply__T__sci_Seq__Ljapgolly_scalajs_react_vdom_TagOf(this$80, self$4, xs$4), ($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$(), $m_Ljapgolly_scalajs_react_vdom_VdomNode$(), new $c_Ljapgolly_scalajs_react_vdom_VdomNode$$anon$1("built for automation."))]));
    var $x_41 = $f_Ljapgolly_scalajs_react_vdom_TagLite__apply__T__sci_Seq__Ljapgolly_scalajs_react_vdom_TagOf(this$83, self$5, xs$5);
    var this$89 = $m_Ljapgolly_scalajs_react_vdom_HtmlTagOf$();
    $n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$less);
    $n($m_Ljapgolly_scalajs_react_vdom_Exports$().Ljapgolly_scalajs_react_vdom_Exports__f_HtmlTagOf);
    var self$6 = "p";
    var xs$6 = $m_sr_ScalaRunTime$().wrapRefArray__AO__sci_ArraySeq(new ($d_Ljapgolly_scalajs_react_vdom_TagMod.getArrayOf().constr)([($n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$up), $m_Ljapgolly_scalajs_react_vdom_Attr$ClassName$()).$colon$eq__O__F2__Ljapgolly_scalajs_react_vdom_TagMod("text-lg text-gray-500 max-w-2xl leading-relaxed mb-10", $m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_PackageBase__f_vdomAttrVtString), ($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$(), $m_Ljapgolly_scalajs_react_vdom_VdomNode$(), new $c_Ljapgolly_scalajs_react_vdom_VdomNode$$anon$1("aathu compiles to bytecode and runs on a custom VM. Clean syntax, static types, and a full toolchain \u2014 formatter, linter, LSP, debugger, and package manager included."))]));
    var $x_37 = $f_Ljapgolly_scalajs_react_vdom_TagLite__apply__T__sci_Seq__Ljapgolly_scalajs_react_vdom_TagOf(this$89, self$6, xs$6);
    var this$106 = $m_Ljapgolly_scalajs_react_vdom_HtmlTagOf$();
    $n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$less);
    $n($m_Ljapgolly_scalajs_react_vdom_Exports$().Ljapgolly_scalajs_react_vdom_Exports__f_HtmlTagOf);
    var self$7 = "div";
    var $x_36 = $m_sr_ScalaRunTime$();
    var $x_35 = ($n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$up), $m_Ljapgolly_scalajs_react_vdom_Attr$ClassName$()).$colon$eq__O__F2__Ljapgolly_scalajs_react_vdom_TagMod("flex items-center gap-4", $m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_PackageBase__f_vdomAttrVtString);
    var $x_34 = $n($n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$less).a__Ljapgolly_scalajs_react_vdom_HtmlTags$a$());
    var $x_33 = $m_sr_ScalaRunTime$();
    $n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$up);
    var this$94 = $ct_Ljapgolly_scalajs_react_vdom_Attr$Generic__T__(new $c_Ljapgolly_scalajs_react_vdom_Attr$Generic(), "href");
    var a$1 = this.Llanding_Main$__f_githubUrl;
    var t$7 = $m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_PackageBase__f_vdomAttrVtString;
    var $x_32 = $m_Ljapgolly_scalajs_react_vdom_Attr$ValueType$().apply$extension__F2__T__O__Ljapgolly_scalajs_react_vdom_TagMod(t$7, this$94.Ljapgolly_scalajs_react_vdom_Attr__f_attrName, a$1);
    var this$95 = $n($n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$up).target__Ljapgolly_scalajs_react_vdom_HtmlAttrs$target$());
    var t$8 = $m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_PackageBase__f_vdomAttrVtString;
    var $x_31 = $m_Ljapgolly_scalajs_react_vdom_Attr$ValueType$().apply$extension__F2__T__O__Ljapgolly_scalajs_react_vdom_TagMod(t$8, this$95.Ljapgolly_scalajs_react_vdom_Attr__f_attrName, "_blank");
    $n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$up);
    var this$97 = $ct_Ljapgolly_scalajs_react_vdom_Attr$Generic__T__(new $c_Ljapgolly_scalajs_react_vdom_Attr$Generic(), "rel");
    var t$9 = $m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_PackageBase__f_vdomAttrVtString;
    var $x_30 = $n($x_34).apply__sci_Seq__Ljapgolly_scalajs_react_vdom_TagOf($n($x_33).wrapRefArray__AO__sci_ArraySeq(new ($d_Ljapgolly_scalajs_react_vdom_TagMod.getArrayOf().constr)([$x_32, $x_31, $m_Ljapgolly_scalajs_react_vdom_Attr$ValueType$().apply$extension__F2__T__O__Ljapgolly_scalajs_react_vdom_TagMod(t$9, this$97.Ljapgolly_scalajs_react_vdom_Attr__f_attrName, "noopener noreferrer"), ($n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$up), $m_Ljapgolly_scalajs_react_vdom_Attr$ClassName$()).$colon$eq__O__F2__Ljapgolly_scalajs_react_vdom_TagMod("gradient-btn inline-block text-sm font-medium text-white px-5 py-2.5 rounded-md", $m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_PackageBase__f_vdomAttrVtString), ($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$(), $m_Ljapgolly_scalajs_react_vdom_VdomNode$(), new $c_Ljapgolly_scalajs_react_vdom_VdomNode$$anon$1("View on GitHub \u2197"))])));
    var $x_29 = $n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$less).a__Ljapgolly_scalajs_react_vdom_HtmlTags$a$();
    var $x_28 = $m_sr_ScalaRunTime$();
    $n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$up);
    var this$102 = $ct_Ljapgolly_scalajs_react_vdom_Attr$Generic__T__(new $c_Ljapgolly_scalajs_react_vdom_Attr$Generic(), "href");
    var t$10 = $m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_PackageBase__f_vdomAttrVtString;
    var xs$7 = $n($x_36).wrapRefArray__AO__sci_ArraySeq(new ($d_Ljapgolly_scalajs_react_vdom_TagMod.getArrayOf().constr)([$x_35, $x_30, $n($x_29).apply__sci_Seq__Ljapgolly_scalajs_react_vdom_TagOf($n($x_28).wrapRefArray__AO__sci_ArraySeq(new ($d_Ljapgolly_scalajs_react_vdom_TagMod.getArrayOf().constr)([$m_Ljapgolly_scalajs_react_vdom_Attr$ValueType$().apply$extension__F2__T__O__Ljapgolly_scalajs_react_vdom_TagMod(t$10, this$102.Ljapgolly_scalajs_react_vdom_Attr__f_attrName, "#"), ($n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$up), $m_Ljapgolly_scalajs_react_vdom_Attr$ClassName$()).$colon$eq__O__F2__Ljapgolly_scalajs_react_vdom_TagMod("inline-block text-sm font-medium text-gray-600 hover:text-gray-900 px-5 py-2.5", $m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_PackageBase__f_vdomAttrVtString), ($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$(), $m_Ljapgolly_scalajs_react_vdom_VdomNode$(), new $c_Ljapgolly_scalajs_react_vdom_VdomNode$$anon$1("Read the docs \u2192"))])))]));
    var xs$8 = $n($x_48).wrapRefArray__AO__sci_ArraySeq(new ($d_Ljapgolly_scalajs_react_vdom_TagMod.getArrayOf().constr)([$x_47, $x_46, $x_41, $x_37, $f_Ljapgolly_scalajs_react_vdom_TagLite__apply__T__sci_Seq__Ljapgolly_scalajs_react_vdom_TagOf(this$106, self$7, xs$7)]));
    return $f_Ljapgolly_scalajs_react_vdom_TagLite__apply__T__sci_Seq__Ljapgolly_scalajs_react_vdom_TagOf(this$107, self$8, xs$8);
  })), $m_Ljapgolly_scalajs_react_CtorType$Summoner$().summonN__Ljapgolly_scalajs_react_internal_Singleton__Ljapgolly_scalajs_react_CtorType$Summoner($m_Ljapgolly_scalajs_react_internal_Singleton$().Ljapgolly_scalajs_react_internal_Singleton$__f_BoxUnit));
  var elems = $m_sr_ScalaRunTime$().wrapRefArray__AO__sci_ArraySeq(new ($d_T.getArrayOf().constr)(["Source", "Lexer", "Parser", "HIR", "Type Check", "MIR", "Codegen", "Bytecode", "VM"]));
  this.Llanding_Main$__f_pipelineSteps = $m_sci_Nil$().prependedAll__sc_IterableOnce__sci_List(elems);
  this.Llanding_Main$__f_Pipeline = $n($m_Ljapgolly_scalajs_react_package$().Ljapgolly_scalajs_react_internal_CoreGeneralF__f_ScalaFnComponent).apply__F1__Ljapgolly_scalajs_react_CtorType$Summoner__Ljapgolly_scalajs_react_component_JsBaseComponentTemplate$ComponentWithRoot(new $c_sjsr_AnonFunction1(((_$3) => {
    $as_jl_Void(_$3);
    var this$149 = $m_Ljapgolly_scalajs_react_vdom_HtmlTagOf$();
    $n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$less);
    $n($m_Ljapgolly_scalajs_react_vdom_Exports$().Ljapgolly_scalajs_react_vdom_Exports__f_HtmlTagOf);
    var self$15 = "section";
    var $x_62 = $m_sr_ScalaRunTime$();
    var $x_61 = ($n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$up), $m_Ljapgolly_scalajs_react_vdom_Attr$ClassName$()).$colon$eq__O__F2__Ljapgolly_scalajs_react_vdom_TagMod("border-t border-gray-100 bg-gray-50", $m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_PackageBase__f_vdomAttrVtString);
    var this$148 = $m_Ljapgolly_scalajs_react_vdom_HtmlTagOf$();
    $n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$less);
    $n($m_Ljapgolly_scalajs_react_vdom_Exports$().Ljapgolly_scalajs_react_vdom_Exports__f_HtmlTagOf);
    var self$14 = "div";
    var $x_60 = $m_sr_ScalaRunTime$();
    var $x_59 = ($n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$up), $m_Ljapgolly_scalajs_react_vdom_Attr$ClassName$()).$colon$eq__O__F2__Ljapgolly_scalajs_react_vdom_TagMod("max-w-6xl mx-auto px-8 py-12", $m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_PackageBase__f_vdomAttrVtString);
    var this$120 = $m_Ljapgolly_scalajs_react_vdom_HtmlTagOf$();
    $n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$less);
    $n($m_Ljapgolly_scalajs_react_vdom_Exports$().Ljapgolly_scalajs_react_vdom_Exports__f_HtmlTagOf);
    var self$9 = "p";
    var xs$9 = $m_sr_ScalaRunTime$().wrapRefArray__AO__sci_ArraySeq(new ($d_Ljapgolly_scalajs_react_vdom_TagMod.getArrayOf().constr)([($n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$up), $m_Ljapgolly_scalajs_react_vdom_Attr$ClassName$()).$colon$eq__O__F2__Ljapgolly_scalajs_react_vdom_TagMod("text-xs font-mono uppercase tracking-widest text-gray-400 mb-6", $m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_PackageBase__f_vdomAttrVtString), ($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$(), $m_Ljapgolly_scalajs_react_vdom_VdomNode$(), new $c_Ljapgolly_scalajs_react_vdom_VdomNode$$anon$1("Compiler Pipeline"))]));
    var $x_58 = $f_Ljapgolly_scalajs_react_vdom_TagLite__apply__T__sci_Seq__Ljapgolly_scalajs_react_vdom_TagOf(this$120, self$9, xs$9);
    var this$147 = $m_Ljapgolly_scalajs_react_vdom_HtmlTagOf$();
    $n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$less);
    $n($m_Ljapgolly_scalajs_react_vdom_Exports$().Ljapgolly_scalajs_react_vdom_Exports__f_HtmlTagOf);
    var self$13 = "div";
    var $x_57 = $m_sr_ScalaRunTime$();
    var $x_56 = ($n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$up), $m_Ljapgolly_scalajs_react_vdom_Attr$ClassName$()).$colon$eq__O__F2__Ljapgolly_scalajs_react_vdom_TagMod("flex flex-wrap items-center gap-y-3", $m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_PackageBase__f_vdomAttrVtString);
    $m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$();
    var this$124 = $n(this.Llanding_Main$__f_pipelineSteps);
    var as = $as_sc_IterableOnce($f_sc_StrictOptimizedIterableOps__zipWithIndex__O(this$124));
    var this$127 = $n($m_Ljapgolly_scalajs_react_vdom_VdomArray$().empty__Ljapgolly_scalajs_react_vdom_VdomArray());
    var this$128 = $n($n(as).iterator__sc_Iterator());
    while (this$128.hasNext__Z()) {
      var arg1 = this$128.next__O();
      var $x_55 = this$127.Ljapgolly_scalajs_react_vdom_VdomArray__f_rawArray;
      var x$1 = $as_T2(arg1);
      matchResult1: {
        var $x_50;
        if ((x$1 !== null)) {
          var step = $as_T($n(x$1).T2__f__1);
          var idx = $uI($n(x$1).T2__f__2);
          var this$145 = $m_Ljapgolly_scalajs_react_vdom_HtmlTagOf$();
          $n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$less);
          $n($m_Ljapgolly_scalajs_react_vdom_Exports$().Ljapgolly_scalajs_react_vdom_Exports__f_HtmlTagOf);
          var self$12 = "div";
          var $x_54 = $m_sr_ScalaRunTime$();
          var $x_53 = $n($n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$up).Ljapgolly_scalajs_react_vdom_HtmlAttrAndStyles$__f_key).$colon$eq__O__F2__Ljapgolly_scalajs_react_vdom_TagMod(("" + idx), $m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_PackageBase__f_vdomAttrVtKeyS);
          var $x_52 = ($n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$up), $m_Ljapgolly_scalajs_react_vdom_Attr$ClassName$()).$colon$eq__O__F2__Ljapgolly_scalajs_react_vdom_TagMod("flex items-center", $m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_PackageBase__f_vdomAttrVtString);
          if ((idx > 0)) {
            var this$138 = $m_Ljapgolly_scalajs_react_vdom_HtmlTagOf$();
            $n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$less);
            $n($m_Ljapgolly_scalajs_react_vdom_Exports$().Ljapgolly_scalajs_react_vdom_Exports__f_HtmlTagOf);
            var self$10 = "span";
            var xs$10 = $m_sr_ScalaRunTime$().wrapRefArray__AO__sci_ArraySeq(new ($d_Ljapgolly_scalajs_react_vdom_TagMod.getArrayOf().constr)([($n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$up), $m_Ljapgolly_scalajs_react_vdom_Attr$ClassName$()).$colon$eq__O__F2__Ljapgolly_scalajs_react_vdom_TagMod("text-gray-300 text-sm mx-2", $m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_PackageBase__f_vdomAttrVtString), ($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$(), $m_Ljapgolly_scalajs_react_vdom_VdomNode$(), new $c_Ljapgolly_scalajs_react_vdom_VdomNode$$anon$1("\u2192"))]));
            var $x_51 = $f_Ljapgolly_scalajs_react_vdom_TagLite__apply__T__sci_Seq__Ljapgolly_scalajs_react_vdom_TagOf(this$138, self$10, xs$10);
          } else {
            var $x_51 = $m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_Exports__f_EmptyVdom;
          }
          var this$144 = $m_Ljapgolly_scalajs_react_vdom_HtmlTagOf$();
          $n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$less);
          $n($m_Ljapgolly_scalajs_react_vdom_Exports$().Ljapgolly_scalajs_react_vdom_Exports__f_HtmlTagOf);
          var self$11 = "span";
          var xs$11 = $m_sr_ScalaRunTime$().wrapRefArray__AO__sci_ArraySeq(new ($d_Ljapgolly_scalajs_react_vdom_TagMod.getArrayOf().constr)([($n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$up), $m_Ljapgolly_scalajs_react_vdom_Attr$ClassName$()).$colon$eq__O__F2__Ljapgolly_scalajs_react_vdom_TagMod("text-xs font-mono px-3 py-1.5 bg-white border border-gray-200 rounded text-gray-700", $m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_PackageBase__f_vdomAttrVtString), ($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$(), $m_Ljapgolly_scalajs_react_vdom_VdomNode$(), new $c_Ljapgolly_scalajs_react_vdom_VdomNode$$anon$1(step))]));
          var xs$12 = $n($x_54).wrapRefArray__AO__sci_ArraySeq(new ($d_Ljapgolly_scalajs_react_vdom_TagMod.getArrayOf().constr)([$x_53, $x_52, $x_51, $f_Ljapgolly_scalajs_react_vdom_TagLite__apply__T__sci_Seq__Ljapgolly_scalajs_react_vdom_TagOf(this$144, self$11, xs$11)]));
          var $x_50 = $f_Ljapgolly_scalajs_react_vdom_TagLite__apply__T__sci_Seq__Ljapgolly_scalajs_react_vdom_TagOf(this$145, self$12, xs$12);
          break matchResult1;
        }
        throw new $c_s_MatchError(x$1);
      }
      var this$146 = $n($x_50);
      var $x_49 = $x_55.push(this$146.rawElement__Ljapgolly_scalajs_react_facade_React$Element());
      $uI($x_49);
    }
    var xs$13 = $n($x_57).wrapRefArray__AO__sci_ArraySeq(new ($d_Ljapgolly_scalajs_react_vdom_TagMod.getArrayOf().constr)([$x_56, this$127]));
    var xs$14 = $n($x_60).wrapRefArray__AO__sci_ArraySeq(new ($d_Ljapgolly_scalajs_react_vdom_TagMod.getArrayOf().constr)([$x_59, $x_58, $f_Ljapgolly_scalajs_react_vdom_TagLite__apply__T__sci_Seq__Ljapgolly_scalajs_react_vdom_TagOf(this$147, self$13, xs$13)]));
    var xs$15 = $n($x_62).wrapRefArray__AO__sci_ArraySeq(new ($d_Ljapgolly_scalajs_react_vdom_TagMod.getArrayOf().constr)([$x_61, $f_Ljapgolly_scalajs_react_vdom_TagLite__apply__T__sci_Seq__Ljapgolly_scalajs_react_vdom_TagOf(this$148, self$14, xs$14)]));
    return $f_Ljapgolly_scalajs_react_vdom_TagLite__apply__T__sci_Seq__Ljapgolly_scalajs_react_vdom_TagOf(this$149, self$15, xs$15);
  })), $m_Ljapgolly_scalajs_react_CtorType$Summoner$().summonN__Ljapgolly_scalajs_react_internal_Singleton__Ljapgolly_scalajs_react_CtorType$Summoner($m_Ljapgolly_scalajs_react_internal_Singleton$().Ljapgolly_scalajs_react_internal_Singleton$__f_BoxUnit));
  this.Llanding_Main$__f_codeExample = $m_sc_StringOps$().stripMargin$extension__T__C__T("|fn greet(name) {\r\n       |  print(\"Hello, \" + name + \"!\")\r\n       |}\r\n       |\r\n       |fn main() {\r\n       |  greet(\"world\")\r\n       |\r\n       |  for i in 0..5 {\r\n       |    print(i)\r\n       |  }\r\n       |}", 124);
  this.Llanding_Main$__f_CodeBlock = $n($m_Ljapgolly_scalajs_react_package$().Ljapgolly_scalajs_react_internal_CoreGeneralF__f_ScalaFnComponent).apply__F1__Ljapgolly_scalajs_react_CtorType$Summoner__Ljapgolly_scalajs_react_component_JsBaseComponentTemplate$ComponentWithRoot(new $c_sjsr_AnonFunction1(((_$4) => {
    $as_jl_Void(_$4);
    var this$200 = $m_Ljapgolly_scalajs_react_vdom_HtmlTagOf$();
    $n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$less);
    $n($m_Ljapgolly_scalajs_react_vdom_Exports$().Ljapgolly_scalajs_react_vdom_Exports__f_HtmlTagOf);
    var self$26 = "section";
    var $x_78 = $m_sr_ScalaRunTime$();
    var $x_77 = ($n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$up), $m_Ljapgolly_scalajs_react_vdom_Attr$ClassName$()).$colon$eq__O__F2__Ljapgolly_scalajs_react_vdom_TagMod("border-t border-gray-100", $m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_PackageBase__f_vdomAttrVtString);
    var this$199 = $m_Ljapgolly_scalajs_react_vdom_HtmlTagOf$();
    $n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$less);
    $n($m_Ljapgolly_scalajs_react_vdom_Exports$().Ljapgolly_scalajs_react_vdom_Exports__f_HtmlTagOf);
    var self$25 = "div";
    var $x_76 = $m_sr_ScalaRunTime$();
    var $x_75 = ($n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$up), $m_Ljapgolly_scalajs_react_vdom_Attr$ClassName$()).$colon$eq__O__F2__Ljapgolly_scalajs_react_vdom_TagMod("max-w-6xl mx-auto px-8 py-20", $m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_PackageBase__f_vdomAttrVtString);
    var this$163 = $m_Ljapgolly_scalajs_react_vdom_HtmlTagOf$();
    $n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$less);
    $n($m_Ljapgolly_scalajs_react_vdom_Exports$().Ljapgolly_scalajs_react_vdom_Exports__f_HtmlTagOf);
    var self$16 = "p";
    var xs$16 = $m_sr_ScalaRunTime$().wrapRefArray__AO__sci_ArraySeq(new ($d_Ljapgolly_scalajs_react_vdom_TagMod.getArrayOf().constr)([($n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$up), $m_Ljapgolly_scalajs_react_vdom_Attr$ClassName$()).$colon$eq__O__F2__Ljapgolly_scalajs_react_vdom_TagMod("text-xs font-mono uppercase tracking-widest text-gray-400 mb-6", $m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_PackageBase__f_vdomAttrVtString), ($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$(), $m_Ljapgolly_scalajs_react_vdom_VdomNode$(), new $c_Ljapgolly_scalajs_react_vdom_VdomNode$$anon$1("Example"))]));
    var $x_74 = $f_Ljapgolly_scalajs_react_vdom_TagLite__apply__T__sci_Seq__Ljapgolly_scalajs_react_vdom_TagOf(this$163, self$16, xs$16);
    var this$198 = $m_Ljapgolly_scalajs_react_vdom_HtmlTagOf$();
    $n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$less);
    $n($m_Ljapgolly_scalajs_react_vdom_Exports$().Ljapgolly_scalajs_react_vdom_Exports__f_HtmlTagOf);
    var self$24 = "div";
    var $x_73 = $m_sr_ScalaRunTime$();
    var $x_72 = ($n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$up), $m_Ljapgolly_scalajs_react_vdom_Attr$ClassName$()).$colon$eq__O__F2__Ljapgolly_scalajs_react_vdom_TagMod("rounded-lg overflow-hidden bg-gray-950 max-w-2xl", $m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_PackageBase__f_vdomAttrVtString);
    var this$188 = $m_Ljapgolly_scalajs_react_vdom_HtmlTagOf$();
    $n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$less);
    $n($m_Ljapgolly_scalajs_react_vdom_Exports$().Ljapgolly_scalajs_react_vdom_Exports__f_HtmlTagOf);
    var self$21 = "div";
    var $x_70 = $m_sr_ScalaRunTime$();
    var $x_69 = ($n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$up), $m_Ljapgolly_scalajs_react_vdom_Attr$ClassName$()).$colon$eq__O__F2__Ljapgolly_scalajs_react_vdom_TagMod("flex items-center gap-2 px-4 py-3 border-b border-gray-800", $m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_PackageBase__f_vdomAttrVtString);
    var this$173 = $m_Ljapgolly_scalajs_react_vdom_HtmlTagOf$();
    $n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$less);
    $n($m_Ljapgolly_scalajs_react_vdom_Exports$().Ljapgolly_scalajs_react_vdom_Exports__f_HtmlTagOf);
    var self$17 = "span";
    var xs$17 = $m_sr_ScalaRunTime$().wrapRefArray__AO__sci_ArraySeq(new ($d_Ljapgolly_scalajs_react_vdom_TagMod.getArrayOf().constr)([($n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$up), $m_Ljapgolly_scalajs_react_vdom_Attr$ClassName$()).$colon$eq__O__F2__Ljapgolly_scalajs_react_vdom_TagMod("w-2.5 h-2.5 rounded-full bg-gray-700", $m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_PackageBase__f_vdomAttrVtString)]));
    var $x_68 = $f_Ljapgolly_scalajs_react_vdom_TagLite__apply__T__sci_Seq__Ljapgolly_scalajs_react_vdom_TagOf(this$173, self$17, xs$17);
    var this$177 = $m_Ljapgolly_scalajs_react_vdom_HtmlTagOf$();
    $n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$less);
    $n($m_Ljapgolly_scalajs_react_vdom_Exports$().Ljapgolly_scalajs_react_vdom_Exports__f_HtmlTagOf);
    var self$18 = "span";
    var xs$18 = $m_sr_ScalaRunTime$().wrapRefArray__AO__sci_ArraySeq(new ($d_Ljapgolly_scalajs_react_vdom_TagMod.getArrayOf().constr)([($n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$up), $m_Ljapgolly_scalajs_react_vdom_Attr$ClassName$()).$colon$eq__O__F2__Ljapgolly_scalajs_react_vdom_TagMod("w-2.5 h-2.5 rounded-full bg-gray-700", $m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_PackageBase__f_vdomAttrVtString)]));
    var $x_67 = $f_Ljapgolly_scalajs_react_vdom_TagLite__apply__T__sci_Seq__Ljapgolly_scalajs_react_vdom_TagOf(this$177, self$18, xs$18);
    var this$181 = $m_Ljapgolly_scalajs_react_vdom_HtmlTagOf$();
    $n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$less);
    $n($m_Ljapgolly_scalajs_react_vdom_Exports$().Ljapgolly_scalajs_react_vdom_Exports__f_HtmlTagOf);
    var self$19 = "span";
    var xs$19 = $m_sr_ScalaRunTime$().wrapRefArray__AO__sci_ArraySeq(new ($d_Ljapgolly_scalajs_react_vdom_TagMod.getArrayOf().constr)([($n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$up), $m_Ljapgolly_scalajs_react_vdom_Attr$ClassName$()).$colon$eq__O__F2__Ljapgolly_scalajs_react_vdom_TagMod("w-2.5 h-2.5 rounded-full bg-gray-700", $m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_PackageBase__f_vdomAttrVtString)]));
    var $x_66 = $f_Ljapgolly_scalajs_react_vdom_TagLite__apply__T__sci_Seq__Ljapgolly_scalajs_react_vdom_TagOf(this$181, self$19, xs$19);
    var this$187 = $m_Ljapgolly_scalajs_react_vdom_HtmlTagOf$();
    $n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$less);
    $n($m_Ljapgolly_scalajs_react_vdom_Exports$().Ljapgolly_scalajs_react_vdom_Exports__f_HtmlTagOf);
    var self$20 = "span";
    var xs$20 = $m_sr_ScalaRunTime$().wrapRefArray__AO__sci_ArraySeq(new ($d_Ljapgolly_scalajs_react_vdom_TagMod.getArrayOf().constr)([($n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$up), $m_Ljapgolly_scalajs_react_vdom_Attr$ClassName$()).$colon$eq__O__F2__Ljapgolly_scalajs_react_vdom_TagMod("ml-2 text-xs text-gray-500 font-mono", $m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_PackageBase__f_vdomAttrVtString), ($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$(), $m_Ljapgolly_scalajs_react_vdom_VdomNode$(), new $c_Ljapgolly_scalajs_react_vdom_VdomNode$$anon$1("hello.aathu"))]));
    var xs$21 = $n($x_70).wrapRefArray__AO__sci_ArraySeq(new ($d_Ljapgolly_scalajs_react_vdom_TagMod.getArrayOf().constr)([$x_69, $x_68, $x_67, $x_66, $f_Ljapgolly_scalajs_react_vdom_TagLite__apply__T__sci_Seq__Ljapgolly_scalajs_react_vdom_TagOf(this$187, self$20, xs$20)]));
    var $x_71 = $f_Ljapgolly_scalajs_react_vdom_TagLite__apply__T__sci_Seq__Ljapgolly_scalajs_react_vdom_TagOf(this$188, self$21, xs$21);
    var this$197 = $m_Ljapgolly_scalajs_react_vdom_HtmlTagOf$();
    $n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$less);
    $n($m_Ljapgolly_scalajs_react_vdom_Exports$().Ljapgolly_scalajs_react_vdom_Exports__f_HtmlTagOf);
    var self$23 = "pre";
    var $x_65 = $m_sr_ScalaRunTime$();
    var $x_64 = ($n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$up), $m_Ljapgolly_scalajs_react_vdom_Attr$ClassName$()).$colon$eq__O__F2__Ljapgolly_scalajs_react_vdom_TagMod("px-6 py-5 text-sm font-mono text-gray-300 leading-relaxed overflow-x-auto", $m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_PackageBase__f_vdomAttrVtString);
    var this$196 = $m_Ljapgolly_scalajs_react_vdom_HtmlTagOf$();
    $n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$less);
    $n($m_Ljapgolly_scalajs_react_vdom_Exports$().Ljapgolly_scalajs_react_vdom_Exports__f_HtmlTagOf);
    var self$22 = "code";
    var $x_63 = $m_sr_ScalaRunTime$();
    $m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$();
    var v = this.Llanding_Main$__f_codeExample;
    $m_Ljapgolly_scalajs_react_vdom_VdomNode$();
    var xs$22 = $n($x_63).wrapRefArray__AO__sci_ArraySeq(new ($d_Ljapgolly_scalajs_react_vdom_TagMod.getArrayOf().constr)([new $c_Ljapgolly_scalajs_react_vdom_VdomNode$$anon$1(v)]));
    var xs$23 = $n($x_65).wrapRefArray__AO__sci_ArraySeq(new ($d_Ljapgolly_scalajs_react_vdom_TagMod.getArrayOf().constr)([$x_64, $f_Ljapgolly_scalajs_react_vdom_TagLite__apply__T__sci_Seq__Ljapgolly_scalajs_react_vdom_TagOf(this$196, self$22, xs$22)]));
    var xs$24 = $n($x_73).wrapRefArray__AO__sci_ArraySeq(new ($d_Ljapgolly_scalajs_react_vdom_TagMod.getArrayOf().constr)([$x_72, $x_71, $f_Ljapgolly_scalajs_react_vdom_TagLite__apply__T__sci_Seq__Ljapgolly_scalajs_react_vdom_TagOf(this$197, self$23, xs$23)]));
    var xs$25 = $n($x_76).wrapRefArray__AO__sci_ArraySeq(new ($d_Ljapgolly_scalajs_react_vdom_TagMod.getArrayOf().constr)([$x_75, $x_74, $f_Ljapgolly_scalajs_react_vdom_TagLite__apply__T__sci_Seq__Ljapgolly_scalajs_react_vdom_TagOf(this$198, self$24, xs$24)]));
    var xs$26 = $n($x_78).wrapRefArray__AO__sci_ArraySeq(new ($d_Ljapgolly_scalajs_react_vdom_TagMod.getArrayOf().constr)([$x_77, $f_Ljapgolly_scalajs_react_vdom_TagLite__apply__T__sci_Seq__Ljapgolly_scalajs_react_vdom_TagOf(this$199, self$25, xs$25)]));
    return $f_Ljapgolly_scalajs_react_vdom_TagLite__apply__T__sci_Seq__Ljapgolly_scalajs_react_vdom_TagOf(this$200, self$26, xs$26);
  })), $m_Ljapgolly_scalajs_react_CtorType$Summoner$().summonN__Ljapgolly_scalajs_react_internal_Singleton__Ljapgolly_scalajs_react_CtorType$Summoner($m_Ljapgolly_scalajs_react_internal_Singleton$().Ljapgolly_scalajs_react_internal_Singleton$__f_BoxUnit));
  var elems$1 = $m_sr_ScalaRunTime$().wrapRefArray__AO__sci_ArraySeq(new ($d_Llanding_Main$Feature.getArrayOf().constr)([new $c_Llanding_Main$Feature("Compiler", "Full pipeline \u2014 Lexer, Parser, HIR, MIR, Codegen \u2014 compiles down to bytecode."), new $c_Llanding_Main$Feature("Type Checker", "Static type inference with precise source spans and actionable diagnostics."), new $c_Llanding_Main$Feature("Bytecode VM", "Custom register-based VM with a minimal, fast execution runtime."), new $c_Llanding_Main$Feature("Formatter", "Opinionated code formatter (aathu-fmt) \u2014 one style, zero configuration."), new $c_Llanding_Main$Feature("LSP Server", "Full language server (aathu-lsp) for editor integration and autocomplete."), new $c_Llanding_Main$Feature("Package Manager", "Built-in package manager (aathu-pkg) for managing project dependencies.")]));
  this.Llanding_Main$__f_featureList = $m_sci_Nil$().prependedAll__sc_IterableOnce__sci_List(elems$1);
  this.Llanding_Main$__f_Features = $n($m_Ljapgolly_scalajs_react_package$().Ljapgolly_scalajs_react_internal_CoreGeneralF__f_ScalaFnComponent).apply__F1__Ljapgolly_scalajs_react_CtorType$Summoner__Ljapgolly_scalajs_react_component_JsBaseComponentTemplate$ComponentWithRoot(new $c_sjsr_AnonFunction1(((_$5) => {
    $as_jl_Void(_$5);
    var this$252 = $m_Ljapgolly_scalajs_react_vdom_HtmlTagOf$();
    $n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$less);
    $n($m_Ljapgolly_scalajs_react_vdom_Exports$().Ljapgolly_scalajs_react_vdom_Exports__f_HtmlTagOf);
    var self$33 = "section";
    var $x_99 = $m_sr_ScalaRunTime$();
    var $x_98 = ($n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$up), $m_Ljapgolly_scalajs_react_vdom_Attr$ClassName$()).$colon$eq__O__F2__Ljapgolly_scalajs_react_vdom_TagMod("border-t border-gray-100", $m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_PackageBase__f_vdomAttrVtString);
    var this$251 = $m_Ljapgolly_scalajs_react_vdom_HtmlTagOf$();
    $n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$less);
    $n($m_Ljapgolly_scalajs_react_vdom_Exports$().Ljapgolly_scalajs_react_vdom_Exports__f_HtmlTagOf);
    var self$32 = "div";
    var $x_97 = $m_sr_ScalaRunTime$();
    var $x_96 = ($n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$up), $m_Ljapgolly_scalajs_react_vdom_Attr$ClassName$()).$colon$eq__O__F2__Ljapgolly_scalajs_react_vdom_TagMod("max-w-6xl mx-auto px-8 py-20", $m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_PackageBase__f_vdomAttrVtString);
    var this$219 = $m_Ljapgolly_scalajs_react_vdom_HtmlTagOf$();
    $n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$less);
    $n($m_Ljapgolly_scalajs_react_vdom_Exports$().Ljapgolly_scalajs_react_vdom_Exports__f_HtmlTagOf);
    var self$27 = "p";
    var xs$27 = $m_sr_ScalaRunTime$().wrapRefArray__AO__sci_ArraySeq(new ($d_Ljapgolly_scalajs_react_vdom_TagMod.getArrayOf().constr)([($n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$up), $m_Ljapgolly_scalajs_react_vdom_Attr$ClassName$()).$colon$eq__O__F2__Ljapgolly_scalajs_react_vdom_TagMod("text-xs font-mono uppercase tracking-widest text-gray-400 mb-6", $m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_PackageBase__f_vdomAttrVtString), ($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$(), $m_Ljapgolly_scalajs_react_vdom_VdomNode$(), new $c_Ljapgolly_scalajs_react_vdom_VdomNode$$anon$1("What's included"))]));
    var $x_95 = $f_Ljapgolly_scalajs_react_vdom_TagLite__apply__T__sci_Seq__Ljapgolly_scalajs_react_vdom_TagOf(this$219, self$27, xs$27);
    var this$250 = $m_Ljapgolly_scalajs_react_vdom_HtmlTagOf$();
    $n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$less);
    $n($m_Ljapgolly_scalajs_react_vdom_Exports$().Ljapgolly_scalajs_react_vdom_Exports__f_HtmlTagOf);
    var self$31 = "div";
    var $x_94 = $m_sr_ScalaRunTime$();
    var $x_93 = ($n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$up), $m_Ljapgolly_scalajs_react_vdom_Attr$ClassName$()).$colon$eq__O__F2__Ljapgolly_scalajs_react_vdom_TagMod("grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-10 gap-y-10", $m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_PackageBase__f_vdomAttrVtString);
    $m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$();
    var this$223 = $n(this.Llanding_Main$__f_featureList);
    var as$1 = $as_sc_IterableOnce($f_sc_StrictOptimizedIterableOps__zipWithIndex__O(this$223));
    var this$226 = $n($m_Ljapgolly_scalajs_react_vdom_VdomArray$().empty__Ljapgolly_scalajs_react_vdom_VdomArray());
    var this$227 = $n($n(as$1).iterator__sc_Iterator());
    while (this$227.hasNext__Z()) {
      var arg1$1 = this$227.next__O();
      var $x_92 = this$226.Ljapgolly_scalajs_react_vdom_VdomArray__f_rawArray;
      var x$1$1 = $as_T2(arg1$1);
      matchResult5: {
        var $x_80;
        if ((x$1$1 !== null)) {
          var f = $as_Llanding_Main$Feature($n(x$1$1).T2__f__1);
          var idx$1 = $uI($n(x$1$1).T2__f__2);
          var this$248 = $m_Ljapgolly_scalajs_react_vdom_HtmlTagOf$();
          $n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$less);
          $n($m_Ljapgolly_scalajs_react_vdom_Exports$().Ljapgolly_scalajs_react_vdom_Exports__f_HtmlTagOf);
          var self$30 = "div";
          var $x_91 = $m_sr_ScalaRunTime$();
          var $x_90 = $n($n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$up).Ljapgolly_scalajs_react_vdom_HtmlAttrAndStyles$__f_key).$colon$eq__O__F2__Ljapgolly_scalajs_react_vdom_TagMod(("" + idx$1), $m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_PackageBase__f_vdomAttrVtKeyS);
          var $x_89 = ($n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$up), $m_Ljapgolly_scalajs_react_vdom_Attr$ClassName$()).$colon$eq__O__F2__Ljapgolly_scalajs_react_vdom_TagMod("border-t-2 pt-5", $m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_PackageBase__f_vdomAttrVtString);
          $n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$up);
          var $x_88 = $m_Ljapgolly_scalajs_react_vdom_Attr$Style$();
          var $x_87 = $m_sr_ScalaRunTime$();
          var s$2 = this.Llanding_Main$__f_pink;
          var fields$3 = $n($x_87).wrapRefArray__AO__sci_ArraySeq(new ($d_T2.getArrayOf().constr)([new $c_T2("borderColor", s$2)]));
          var $x_86 = $x_88.$colon$eq__O__F2__Ljapgolly_scalajs_react_vdom_TagMod($m_sjs_js_special_package$().objectLiteral__sci_Seq__sjs_js_Object(fields$3), $m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_PackageBase__f_vdomAttrVtJsObject);
          var this$241 = $m_Ljapgolly_scalajs_react_vdom_HtmlTagOf$();
          $n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$less);
          $n($m_Ljapgolly_scalajs_react_vdom_Exports$().Ljapgolly_scalajs_react_vdom_Exports__f_HtmlTagOf);
          var self$28 = "h3";
          var $x_84 = $m_sr_ScalaRunTime$();
          var $x_83 = ($n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$up), $m_Ljapgolly_scalajs_react_vdom_Attr$ClassName$()).$colon$eq__O__F2__Ljapgolly_scalajs_react_vdom_TagMod("font-semibold text-gray-900 text-sm mb-2", $m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_PackageBase__f_vdomAttrVtString);
          $m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$();
          var v$1 = $n(f).Llanding_Main$Feature__f_title;
          $m_Ljapgolly_scalajs_react_vdom_VdomNode$();
          var xs$28 = $n($x_84).wrapRefArray__AO__sci_ArraySeq(new ($d_Ljapgolly_scalajs_react_vdom_TagMod.getArrayOf().constr)([$x_83, new $c_Ljapgolly_scalajs_react_vdom_VdomNode$$anon$1(v$1)]));
          var $x_85 = $f_Ljapgolly_scalajs_react_vdom_TagLite__apply__T__sci_Seq__Ljapgolly_scalajs_react_vdom_TagOf(this$241, self$28, xs$28);
          var this$247 = $m_Ljapgolly_scalajs_react_vdom_HtmlTagOf$();
          $n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$less);
          $n($m_Ljapgolly_scalajs_react_vdom_Exports$().Ljapgolly_scalajs_react_vdom_Exports__f_HtmlTagOf);
          var self$29 = "p";
          var $x_82 = $m_sr_ScalaRunTime$();
          var $x_81 = ($n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$up), $m_Ljapgolly_scalajs_react_vdom_Attr$ClassName$()).$colon$eq__O__F2__Ljapgolly_scalajs_react_vdom_TagMod("text-sm text-gray-500 leading-relaxed", $m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_PackageBase__f_vdomAttrVtString);
          $m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$();
          var v$2 = $n(f).Llanding_Main$Feature__f_desc;
          $m_Ljapgolly_scalajs_react_vdom_VdomNode$();
          var xs$29 = $n($x_82).wrapRefArray__AO__sci_ArraySeq(new ($d_Ljapgolly_scalajs_react_vdom_TagMod.getArrayOf().constr)([$x_81, new $c_Ljapgolly_scalajs_react_vdom_VdomNode$$anon$1(v$2)]));
          var xs$30 = $n($x_91).wrapRefArray__AO__sci_ArraySeq(new ($d_Ljapgolly_scalajs_react_vdom_TagMod.getArrayOf().constr)([$x_90, $x_89, $x_86, $x_85, $f_Ljapgolly_scalajs_react_vdom_TagLite__apply__T__sci_Seq__Ljapgolly_scalajs_react_vdom_TagOf(this$247, self$29, xs$29)]));
          var $x_80 = $f_Ljapgolly_scalajs_react_vdom_TagLite__apply__T__sci_Seq__Ljapgolly_scalajs_react_vdom_TagOf(this$248, self$30, xs$30);
          break matchResult5;
        }
        throw new $c_s_MatchError(x$1$1);
      }
      var this$249 = $n($x_80);
      var $x_79 = $x_92.push(this$249.rawElement__Ljapgolly_scalajs_react_facade_React$Element());
      $uI($x_79);
    }
    var xs$31 = $n($x_94).wrapRefArray__AO__sci_ArraySeq(new ($d_Ljapgolly_scalajs_react_vdom_TagMod.getArrayOf().constr)([$x_93, this$226]));
    var xs$32 = $n($x_97).wrapRefArray__AO__sci_ArraySeq(new ($d_Ljapgolly_scalajs_react_vdom_TagMod.getArrayOf().constr)([$x_96, $x_95, $f_Ljapgolly_scalajs_react_vdom_TagLite__apply__T__sci_Seq__Ljapgolly_scalajs_react_vdom_TagOf(this$250, self$31, xs$31)]));
    var xs$33 = $n($x_99).wrapRefArray__AO__sci_ArraySeq(new ($d_Ljapgolly_scalajs_react_vdom_TagMod.getArrayOf().constr)([$x_98, $f_Ljapgolly_scalajs_react_vdom_TagLite__apply__T__sci_Seq__Ljapgolly_scalajs_react_vdom_TagOf(this$251, self$32, xs$32)]));
    return $f_Ljapgolly_scalajs_react_vdom_TagLite__apply__T__sci_Seq__Ljapgolly_scalajs_react_vdom_TagOf(this$252, self$33, xs$33);
  })), $m_Ljapgolly_scalajs_react_CtorType$Summoner$().summonN__Ljapgolly_scalajs_react_internal_Singleton__Ljapgolly_scalajs_react_CtorType$Summoner($m_Ljapgolly_scalajs_react_internal_Singleton$().Ljapgolly_scalajs_react_internal_Singleton$__f_BoxUnit));
  this.Llanding_Main$__f_Footer = $n($m_Ljapgolly_scalajs_react_package$().Ljapgolly_scalajs_react_internal_CoreGeneralF__f_ScalaFnComponent).apply__F1__Ljapgolly_scalajs_react_CtorType$Summoner__Ljapgolly_scalajs_react_component_JsBaseComponentTemplate$ComponentWithRoot(new $c_sjsr_AnonFunction1(((_$6) => {
    $as_jl_Void(_$6);
    var this$316 = $m_Ljapgolly_scalajs_react_vdom_HtmlTagOf$();
    $n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$less);
    $n($m_Ljapgolly_scalajs_react_vdom_Exports$().Ljapgolly_scalajs_react_vdom_Exports__f_HtmlTagOf);
    var self$42 = "footer";
    var $x_126 = $m_sr_ScalaRunTime$();
    var $x_125 = ($n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$up), $m_Ljapgolly_scalajs_react_vdom_Attr$ClassName$()).$colon$eq__O__F2__Ljapgolly_scalajs_react_vdom_TagMod("border-t border-gray-200 bg-gray-50", $m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_PackageBase__f_vdomAttrVtString);
    var this$315 = $m_Ljapgolly_scalajs_react_vdom_HtmlTagOf$();
    $n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$less);
    $n($m_Ljapgolly_scalajs_react_vdom_Exports$().Ljapgolly_scalajs_react_vdom_Exports__f_HtmlTagOf);
    var self$41 = "div";
    var $x_124 = $m_sr_ScalaRunTime$();
    var $x_123 = ($n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$up), $m_Ljapgolly_scalajs_react_vdom_Attr$ClassName$()).$colon$eq__O__F2__Ljapgolly_scalajs_react_vdom_TagMod("max-w-6xl mx-auto px-8 py-10 flex flex-col sm:flex-row items-start justify-between gap-8", $m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_PackageBase__f_vdomAttrVtString);
    var this$273 = $m_Ljapgolly_scalajs_react_vdom_HtmlTagOf$();
    $n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$less);
    $n($m_Ljapgolly_scalajs_react_vdom_Exports$().Ljapgolly_scalajs_react_vdom_Exports__f_HtmlTagOf);
    var self$36 = "div";
    var $x_121 = $m_sr_ScalaRunTime$();
    var this$266 = $m_Ljapgolly_scalajs_react_vdom_HtmlTagOf$();
    $n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$less);
    $n($m_Ljapgolly_scalajs_react_vdom_Exports$().Ljapgolly_scalajs_react_vdom_Exports__f_HtmlTagOf);
    var self$34 = "span";
    var xs$34 = $m_sr_ScalaRunTime$().wrapRefArray__AO__sci_ArraySeq(new ($d_Ljapgolly_scalajs_react_vdom_TagMod.getArrayOf().constr)([($n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$up), $m_Ljapgolly_scalajs_react_vdom_Attr$ClassName$()).$colon$eq__O__F2__Ljapgolly_scalajs_react_vdom_TagMod("gradient-text font-mono font-bold text-base mb-1 block", $m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_PackageBase__f_vdomAttrVtString), ($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$(), $m_Ljapgolly_scalajs_react_vdom_VdomNode$(), new $c_Ljapgolly_scalajs_react_vdom_VdomNode$$anon$1("aathu"))]));
    var $x_120 = $f_Ljapgolly_scalajs_react_vdom_TagLite__apply__T__sci_Seq__Ljapgolly_scalajs_react_vdom_TagOf(this$266, self$34, xs$34);
    var this$272 = $m_Ljapgolly_scalajs_react_vdom_HtmlTagOf$();
    $n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$less);
    $n($m_Ljapgolly_scalajs_react_vdom_Exports$().Ljapgolly_scalajs_react_vdom_Exports__f_HtmlTagOf);
    var self$35 = "p";
    var xs$35 = $m_sr_ScalaRunTime$().wrapRefArray__AO__sci_ArraySeq(new ($d_Ljapgolly_scalajs_react_vdom_TagMod.getArrayOf().constr)([($n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$up), $m_Ljapgolly_scalajs_react_vdom_Attr$ClassName$()).$colon$eq__O__F2__Ljapgolly_scalajs_react_vdom_TagMod("text-xs text-gray-400 mt-1", $m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_PackageBase__f_vdomAttrVtString), ($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$(), $m_Ljapgolly_scalajs_react_vdom_VdomNode$(), new $c_Ljapgolly_scalajs_react_vdom_VdomNode$$anon$1("A compiled language built for automation."))]));
    var xs$36 = $n($x_121).wrapRefArray__AO__sci_ArraySeq(new ($d_Ljapgolly_scalajs_react_vdom_TagMod.getArrayOf().constr)([$x_120, $f_Ljapgolly_scalajs_react_vdom_TagLite__apply__T__sci_Seq__Ljapgolly_scalajs_react_vdom_TagOf(this$272, self$35, xs$35)]));
    var $x_122 = $f_Ljapgolly_scalajs_react_vdom_TagLite__apply__T__sci_Seq__Ljapgolly_scalajs_react_vdom_TagOf(this$273, self$36, xs$36);
    var this$314 = $m_Ljapgolly_scalajs_react_vdom_HtmlTagOf$();
    $n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$less);
    $n($m_Ljapgolly_scalajs_react_vdom_Exports$().Ljapgolly_scalajs_react_vdom_Exports__f_HtmlTagOf);
    var self$40 = "div";
    var $x_119 = $m_sr_ScalaRunTime$();
    var $x_118 = ($n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$up), $m_Ljapgolly_scalajs_react_vdom_Attr$ClassName$()).$colon$eq__O__F2__Ljapgolly_scalajs_react_vdom_TagMod("flex gap-8 text-sm text-gray-500", $m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_PackageBase__f_vdomAttrVtString);
    var this$295 = $m_Ljapgolly_scalajs_react_vdom_HtmlTagOf$();
    $n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$less);
    $n($m_Ljapgolly_scalajs_react_vdom_Exports$().Ljapgolly_scalajs_react_vdom_Exports__f_HtmlTagOf);
    var self$37 = "div";
    var $x_116 = $m_sr_ScalaRunTime$();
    var $x_115 = ($n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$up), $m_Ljapgolly_scalajs_react_vdom_Attr$ClassName$()).$colon$eq__O__F2__Ljapgolly_scalajs_react_vdom_TagMod("flex flex-col gap-2", $m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_PackageBase__f_vdomAttrVtString);
    var $x_114 = $n($n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$less).a__Ljapgolly_scalajs_react_vdom_HtmlTags$a$());
    var $x_113 = $m_sr_ScalaRunTime$();
    $n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$up);
    var this$281 = $ct_Ljapgolly_scalajs_react_vdom_Attr$Generic__T__(new $c_Ljapgolly_scalajs_react_vdom_Attr$Generic(), "href");
    var t$11 = $m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_PackageBase__f_vdomAttrVtString;
    var $x_112 = $n($x_114).apply__sci_Seq__Ljapgolly_scalajs_react_vdom_TagOf($n($x_113).wrapRefArray__AO__sci_ArraySeq(new ($d_Ljapgolly_scalajs_react_vdom_TagMod.getArrayOf().constr)([$m_Ljapgolly_scalajs_react_vdom_Attr$ValueType$().apply$extension__F2__T__O__Ljapgolly_scalajs_react_vdom_TagMod(t$11, this$281.Ljapgolly_scalajs_react_vdom_Attr__f_attrName, "#"), ($n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$up), $m_Ljapgolly_scalajs_react_vdom_Attr$ClassName$()).$colon$eq__O__F2__Ljapgolly_scalajs_react_vdom_TagMod("hover:text-gray-900", $m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_PackageBase__f_vdomAttrVtString), ($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$(), $m_Ljapgolly_scalajs_react_vdom_VdomNode$(), new $c_Ljapgolly_scalajs_react_vdom_VdomNode$$anon$1("Docs"))])));
    var $x_111 = $n($n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$less).a__Ljapgolly_scalajs_react_vdom_HtmlTags$a$());
    var $x_110 = $m_sr_ScalaRunTime$();
    $n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$up);
    var this$286 = $ct_Ljapgolly_scalajs_react_vdom_Attr$Generic__T__(new $c_Ljapgolly_scalajs_react_vdom_Attr$Generic(), "href");
    var t$12 = $m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_PackageBase__f_vdomAttrVtString;
    var $x_109 = $n($x_111).apply__sci_Seq__Ljapgolly_scalajs_react_vdom_TagOf($n($x_110).wrapRefArray__AO__sci_ArraySeq(new ($d_Ljapgolly_scalajs_react_vdom_TagMod.getArrayOf().constr)([$m_Ljapgolly_scalajs_react_vdom_Attr$ValueType$().apply$extension__F2__T__O__Ljapgolly_scalajs_react_vdom_TagMod(t$12, this$286.Ljapgolly_scalajs_react_vdom_Attr__f_attrName, "#"), ($n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$up), $m_Ljapgolly_scalajs_react_vdom_Attr$ClassName$()).$colon$eq__O__F2__Ljapgolly_scalajs_react_vdom_TagMod("hover:text-gray-900", $m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_PackageBase__f_vdomAttrVtString), ($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$(), $m_Ljapgolly_scalajs_react_vdom_VdomNode$(), new $c_Ljapgolly_scalajs_react_vdom_VdomNode$$anon$1("Examples"))])));
    var $x_108 = $n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$less).a__Ljapgolly_scalajs_react_vdom_HtmlTags$a$();
    var $x_107 = $m_sr_ScalaRunTime$();
    $n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$up);
    var this$291 = $ct_Ljapgolly_scalajs_react_vdom_Attr$Generic__T__(new $c_Ljapgolly_scalajs_react_vdom_Attr$Generic(), "href");
    var t$13 = $m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_PackageBase__f_vdomAttrVtString;
    var xs$37 = $n($x_116).wrapRefArray__AO__sci_ArraySeq(new ($d_Ljapgolly_scalajs_react_vdom_TagMod.getArrayOf().constr)([$x_115, $x_112, $x_109, $n($x_108).apply__sci_Seq__Ljapgolly_scalajs_react_vdom_TagOf($n($x_107).wrapRefArray__AO__sci_ArraySeq(new ($d_Ljapgolly_scalajs_react_vdom_TagMod.getArrayOf().constr)([$m_Ljapgolly_scalajs_react_vdom_Attr$ValueType$().apply$extension__F2__T__O__Ljapgolly_scalajs_react_vdom_TagMod(t$13, this$291.Ljapgolly_scalajs_react_vdom_Attr__f_attrName, "#"), ($n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$up), $m_Ljapgolly_scalajs_react_vdom_Attr$ClassName$()).$colon$eq__O__F2__Ljapgolly_scalajs_react_vdom_TagMod("hover:text-gray-900", $m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_PackageBase__f_vdomAttrVtString), ($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$(), $m_Ljapgolly_scalajs_react_vdom_VdomNode$(), new $c_Ljapgolly_scalajs_react_vdom_VdomNode$$anon$1("Changelog"))])))]));
    var $x_117 = $f_Ljapgolly_scalajs_react_vdom_TagLite__apply__T__sci_Seq__Ljapgolly_scalajs_react_vdom_TagOf(this$295, self$37, xs$37);
    var this$313 = $m_Ljapgolly_scalajs_react_vdom_HtmlTagOf$();
    $n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$less);
    $n($m_Ljapgolly_scalajs_react_vdom_Exports$().Ljapgolly_scalajs_react_vdom_Exports__f_HtmlTagOf);
    var self$39 = "div";
    var $x_106 = $m_sr_ScalaRunTime$();
    var $x_105 = ($n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$up), $m_Ljapgolly_scalajs_react_vdom_Attr$ClassName$()).$colon$eq__O__F2__Ljapgolly_scalajs_react_vdom_TagMod("flex flex-col gap-2", $m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_PackageBase__f_vdomAttrVtString);
    var $x_104 = $n($n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$less).a__Ljapgolly_scalajs_react_vdom_HtmlTags$a$());
    var $x_103 = $m_sr_ScalaRunTime$();
    $n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$up);
    var this$300 = $ct_Ljapgolly_scalajs_react_vdom_Attr$Generic__T__(new $c_Ljapgolly_scalajs_react_vdom_Attr$Generic(), "href");
    var a$2 = this.Llanding_Main$__f_githubUrl;
    var t$14 = $m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_PackageBase__f_vdomAttrVtString;
    var $x_102 = $m_Ljapgolly_scalajs_react_vdom_Attr$ValueType$().apply$extension__F2__T__O__Ljapgolly_scalajs_react_vdom_TagMod(t$14, this$300.Ljapgolly_scalajs_react_vdom_Attr__f_attrName, a$2);
    var this$301 = $n($n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$up).target__Ljapgolly_scalajs_react_vdom_HtmlAttrs$target$());
    var t$15 = $m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_PackageBase__f_vdomAttrVtString;
    var $x_101 = $m_Ljapgolly_scalajs_react_vdom_Attr$ValueType$().apply$extension__F2__T__O__Ljapgolly_scalajs_react_vdom_TagMod(t$15, this$301.Ljapgolly_scalajs_react_vdom_Attr__f_attrName, "_blank");
    $n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$up);
    var this$303 = $ct_Ljapgolly_scalajs_react_vdom_Attr$Generic__T__(new $c_Ljapgolly_scalajs_react_vdom_Attr$Generic(), "rel");
    var t$16 = $m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_PackageBase__f_vdomAttrVtString;
    var $x_100 = $n($x_104).apply__sci_Seq__Ljapgolly_scalajs_react_vdom_TagOf($n($x_103).wrapRefArray__AO__sci_ArraySeq(new ($d_Ljapgolly_scalajs_react_vdom_TagMod.getArrayOf().constr)([$x_102, $x_101, $m_Ljapgolly_scalajs_react_vdom_Attr$ValueType$().apply$extension__F2__T__O__Ljapgolly_scalajs_react_vdom_TagMod(t$16, this$303.Ljapgolly_scalajs_react_vdom_Attr__f_attrName, "noopener noreferrer"), ($n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$up), $m_Ljapgolly_scalajs_react_vdom_Attr$ClassName$()).$colon$eq__O__F2__Ljapgolly_scalajs_react_vdom_TagMod("hover:text-gray-900", $m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_PackageBase__f_vdomAttrVtString), ($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$(), $m_Ljapgolly_scalajs_react_vdom_VdomNode$(), new $c_Ljapgolly_scalajs_react_vdom_VdomNode$$anon$1("GitHub"))])));
    var this$312 = $m_Ljapgolly_scalajs_react_vdom_HtmlTagOf$();
    $n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$less);
    $n($m_Ljapgolly_scalajs_react_vdom_Exports$().Ljapgolly_scalajs_react_vdom_Exports__f_HtmlTagOf);
    var self$38 = "span";
    var xs$38 = $m_sr_ScalaRunTime$().wrapRefArray__AO__sci_ArraySeq(new ($d_Ljapgolly_scalajs_react_vdom_TagMod.getArrayOf().constr)([($n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$up), $m_Ljapgolly_scalajs_react_vdom_Attr$ClassName$()).$colon$eq__O__F2__Ljapgolly_scalajs_react_vdom_TagMod("text-gray-400", $m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_PackageBase__f_vdomAttrVtString), ($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$(), $m_Ljapgolly_scalajs_react_vdom_VdomNode$(), new $c_Ljapgolly_scalajs_react_vdom_VdomNode$$anon$1("MIT License"))]));
    var xs$39 = $n($x_106).wrapRefArray__AO__sci_ArraySeq(new ($d_Ljapgolly_scalajs_react_vdom_TagMod.getArrayOf().constr)([$x_105, $x_100, $f_Ljapgolly_scalajs_react_vdom_TagLite__apply__T__sci_Seq__Ljapgolly_scalajs_react_vdom_TagOf(this$312, self$38, xs$38)]));
    var xs$40 = $n($x_119).wrapRefArray__AO__sci_ArraySeq(new ($d_Ljapgolly_scalajs_react_vdom_TagMod.getArrayOf().constr)([$x_118, $x_117, $f_Ljapgolly_scalajs_react_vdom_TagLite__apply__T__sci_Seq__Ljapgolly_scalajs_react_vdom_TagOf(this$313, self$39, xs$39)]));
    var xs$41 = $n($x_124).wrapRefArray__AO__sci_ArraySeq(new ($d_Ljapgolly_scalajs_react_vdom_TagMod.getArrayOf().constr)([$x_123, $x_122, $f_Ljapgolly_scalajs_react_vdom_TagLite__apply__T__sci_Seq__Ljapgolly_scalajs_react_vdom_TagOf(this$314, self$40, xs$40)]));
    var xs$42 = $n($x_126).wrapRefArray__AO__sci_ArraySeq(new ($d_Ljapgolly_scalajs_react_vdom_TagMod.getArrayOf().constr)([$x_125, $f_Ljapgolly_scalajs_react_vdom_TagLite__apply__T__sci_Seq__Ljapgolly_scalajs_react_vdom_TagOf(this$315, self$41, xs$41)]));
    return $f_Ljapgolly_scalajs_react_vdom_TagLite__apply__T__sci_Seq__Ljapgolly_scalajs_react_vdom_TagOf(this$316, self$42, xs$42);
  })), $m_Ljapgolly_scalajs_react_CtorType$Summoner$().summonN__Ljapgolly_scalajs_react_internal_Singleton__Ljapgolly_scalajs_react_CtorType$Summoner($m_Ljapgolly_scalajs_react_internal_Singleton$().Ljapgolly_scalajs_react_internal_Singleton$__f_BoxUnit));
  this.Llanding_Main$__f_App = $n($m_Ljapgolly_scalajs_react_package$().Ljapgolly_scalajs_react_internal_CoreGeneralF__f_ScalaFnComponent).apply__F1__Ljapgolly_scalajs_react_CtorType$Summoner__Ljapgolly_scalajs_react_component_JsBaseComponentTemplate$ComponentWithRoot(new $c_sjsr_AnonFunction1(((_$7) => {
    $as_jl_Void(_$7);
    var this$348 = $m_Ljapgolly_scalajs_react_vdom_HtmlTagOf$();
    $n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$less);
    $n($m_Ljapgolly_scalajs_react_vdom_Exports$().Ljapgolly_scalajs_react_vdom_Exports__f_HtmlTagOf);
    var self$44 = "div";
    var $x_134 = $m_sr_ScalaRunTime$();
    var $x_133 = ($n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$up), $m_Ljapgolly_scalajs_react_vdom_Attr$ClassName$()).$colon$eq__O__F2__Ljapgolly_scalajs_react_vdom_TagMod("min-h-screen bg-white text-gray-900 antialiased", $m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_PackageBase__f_vdomAttrVtString);
    var this$323 = $m_Ljapgolly_scalajs_react_vdom_HtmlTagOf$();
    $n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$less);
    $n($m_Ljapgolly_scalajs_react_vdom_Exports$().Ljapgolly_scalajs_react_vdom_Exports__f_HtmlTagOf);
    var self$43 = "div";
    var xs$43 = $m_sr_ScalaRunTime$().wrapRefArray__AO__sci_ArraySeq(new ($d_Ljapgolly_scalajs_react_vdom_TagMod.getArrayOf().constr)([($n($m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$__f_$up), $m_Ljapgolly_scalajs_react_vdom_Attr$ClassName$()).$colon$eq__O__F2__Ljapgolly_scalajs_react_vdom_TagMod("gradient-bar", $m_Ljapgolly_scalajs_react_vdom_html\uff3f$less$up$().Ljapgolly_scalajs_react_vdom_PackageBase__f_vdomAttrVtString)]));
    var $x_132 = $f_Ljapgolly_scalajs_react_vdom_TagLite__apply__T__sci_Seq__Ljapgolly_scalajs_react_vdom_TagOf(this$323, self$43, xs$43);
    var c = this.Llanding_Main$__f_Navbar;
    var u = $as_Ljapgolly_scalajs_react_component_Generic$UnmountedRaw($n($as_Ljapgolly_scalajs_react_CtorType$Nullary($n(c).ctor__Ljapgolly_scalajs_react_CtorType())).apply__O());
    var this$326 = $n(u);
    var n = this$326.raw__Ljapgolly_scalajs_react_facade_React$ComponentElement();
    var $x_131 = new $c_Ljapgolly_scalajs_react_vdom_VdomElement$$anon$1(n);
    var c$1 = this.Llanding_Main$__f_Hero;
    var u$1 = $as_Ljapgolly_scalajs_react_component_Generic$UnmountedRaw($n($as_Ljapgolly_scalajs_react_CtorType$Nullary($n(c$1).ctor__Ljapgolly_scalajs_react_CtorType())).apply__O());
    var this$330 = $n(u$1);
    var n$1 = this$330.raw__Ljapgolly_scalajs_react_facade_React$ComponentElement();
    var $x_130 = new $c_Ljapgolly_scalajs_react_vdom_VdomElement$$anon$1(n$1);
    var c$2 = this.Llanding_Main$__f_Pipeline;
    var u$2 = $as_Ljapgolly_scalajs_react_component_Generic$UnmountedRaw($n($as_Ljapgolly_scalajs_react_CtorType$Nullary($n(c$2).ctor__Ljapgolly_scalajs_react_CtorType())).apply__O());
    var this$334 = $n(u$2);
    var n$2 = this$334.raw__Ljapgolly_scalajs_react_facade_React$ComponentElement();
    var $x_129 = new $c_Ljapgolly_scalajs_react_vdom_VdomElement$$anon$1(n$2);
    var c$3 = this.Llanding_Main$__f_CodeBlock;
    var u$3 = $as_Ljapgolly_scalajs_react_component_Generic$UnmountedRaw($n($as_Ljapgolly_scalajs_react_CtorType$Nullary($n(c$3).ctor__Ljapgolly_scalajs_react_CtorType())).apply__O());
    var this$338 = $n(u$3);
    var n$3 = this$338.raw__Ljapgolly_scalajs_react_facade_React$ComponentElement();
    var $x_128 = new $c_Ljapgolly_scalajs_react_vdom_VdomElement$$anon$1(n$3);
    var c$4 = this.Llanding_Main$__f_Features;
    var u$4 = $as_Ljapgolly_scalajs_react_component_Generic$UnmountedRaw($n($as_Ljapgolly_scalajs_react_CtorType$Nullary($n(c$4).ctor__Ljapgolly_scalajs_react_CtorType())).apply__O());
    var this$342 = $n(u$4);
    var n$4 = this$342.raw__Ljapgolly_scalajs_react_facade_React$ComponentElement();
    var $x_127 = new $c_Ljapgolly_scalajs_react_vdom_VdomElement$$anon$1(n$4);
    var c$5 = this.Llanding_Main$__f_Footer;
    var u$5 = $as_Ljapgolly_scalajs_react_component_Generic$UnmountedRaw($n($as_Ljapgolly_scalajs_react_CtorType$Nullary($n(c$5).ctor__Ljapgolly_scalajs_react_CtorType())).apply__O());
    var this$346 = $n(u$5);
    var n$5 = this$346.raw__Ljapgolly_scalajs_react_facade_React$ComponentElement();
    var xs$44 = $n($x_134).wrapRefArray__AO__sci_ArraySeq(new ($d_Ljapgolly_scalajs_react_vdom_TagMod.getArrayOf().constr)([$x_133, $x_132, $x_131, $x_130, $x_129, $x_128, $x_127, new $c_Ljapgolly_scalajs_react_vdom_VdomElement$$anon$1(n$5)]));
    return $f_Ljapgolly_scalajs_react_vdom_TagLite__apply__T__sci_Seq__Ljapgolly_scalajs_react_vdom_TagOf(this$348, self$44, xs$44);
  })), $m_Ljapgolly_scalajs_react_CtorType$Summoner$().summonN__Ljapgolly_scalajs_react_internal_Singleton__Ljapgolly_scalajs_react_CtorType$Summoner($m_Ljapgolly_scalajs_react_internal_Singleton$().Ljapgolly_scalajs_react_internal_Singleton$__f_BoxUnit));
}
$c_Llanding_Main$.prototype = new $h_O();
$c_Llanding_Main$.prototype.constructor = $c_Llanding_Main$;
/** @constructor */
function $h_Llanding_Main$() {
}
$h_Llanding_Main$.prototype = $c_Llanding_Main$.prototype;
$c_Llanding_Main$.prototype.main__AT__V = (function(args) {
  var container = document.getElementById("root");
  var c = this.Llanding_Main$__f_App;
  var this$2 = $n($as_Ljapgolly_scalajs_react_component_JsFn$UnmountedSimple($n($as_Ljapgolly_scalajs_react_CtorType$Nullary($n(c).ctor__Ljapgolly_scalajs_react_CtorType())).apply__O()));
  $f_Ljapgolly_scalajs_react_component_JsFn$UnmountedSimple__renderIntoDOM__Lorg_scalajs_dom_ParentNode__O(this$2, container);
});
var $d_Llanding_Main$ = new $TypeData().initClass($c_Llanding_Main$, "landing.Main$", ({
  Llanding_Main$: 1
}));
var $n_Llanding_Main$;
function $m_Llanding_Main$() {
  if ((!$n_Llanding_Main$)) {
    $n_Llanding_Main$ = new $c_Llanding_Main$();
  }
  return $n_Llanding_Main$;
}
/** @constructor */
...
function $f_F1__andThen__F1__F1($thiz, g) {
  return new $c_sjsr_AnonFunction1(((x$2) => $n(g).apply__O__O($thiz.apply__O__O(x$2))));
}
function $is_F1(obj) {
...
$c_sjs_js_Any$ObjectCompanionOps$.prototype.properties$extension__sjs_js_Object$__sjs_js_Any__sjs_js_Array = (function(this$, o) {
  var result = [];
  for (var key in o) {
    result.push(key);
  }
...
var $d_sjs_js_Any$ObjectCompanionOps$ = new $TypeData().initClass($c_sjs_js_Any$ObjectCompanionOps$, "scala.scalajs.js.Any$ObjectCompanionOps$", ({
...
var $d_Ljapgolly_scalajs_react_CtorType$$anon$1 = new $TypeData().initClass($c_Ljapgolly_scalajs_react_CtorType$$anon$1, "japgolly.scalajs.react.CtorType$$anon$1", ({
...
var $d_Ljapgolly_scalajs_react_callback_Trampoline$Delay = new $TypeData().initClass($c_Ljapgolly_scalajs_react_callback_Trampoline$Delay, "japgolly.scalajs.react.callback.Trampoline$Delay", ({
...
var $d_Ljapgolly_scalajs_react_callback_Trampoline$Pure = new $TypeData().initClass($c_Ljapgolly_scalajs_react_callback_Trampoline$Pure, "japgolly.scalajs.react.callback.Trampoline$Pure", ({
...
$c_Ljapgolly_scalajs_react_component_JsFn$.prototype.force__O__Ljapgolly_scalajs_react_CtorType$Summoner__Ljapgolly_scalajs_react_component_JsBaseComponentTemplate$ComponentWithRoot = (function(raw, s) {
  var this$2 = $n($n(s).Ljapgolly_scalajs_react_CtorType$$anon$1__f_pf);
  var f = $n($n(s).Ljapgolly_scalajs_react_CtorType$$anon$1__f_summon).apply__O__O(raw);
  ...
  var pf = $n(s).Ljapgolly_scalajs_react_CtorType$$anon$1__f_pf;
...
$c_Ljapgolly_scalajs_react_vdom_Attr$ClassName$.prototype.$colon$eq__O__F2__Ljapgolly_scalajs_react_vdom_TagMod = (function(a, t) {
  var f = new $c_sjsr_AnonFunction1(((b) => {
    var b$1 = $as_Ljapgolly_scalajs_react_vdom_VdomBuilder(b);
    $n(t).apply__O__O__O($n(b$1).Ljapgolly_scalajs_react_vdom_VdomBuilder$ToRawReactElement__f_addClassName, a);
  }));
  return new $c_Ljapgolly_scalajs_react_vdom_TagMod$$anon$3(f);
});
var $d_Ljapgolly_scalajs_react_vdom_Attr$ClassName$ = new $TypeData().initClass($c_Ljapgolly_scalajs_react_vdom_Attr$ClassName$, "japgolly.scalajs.react.vdom.Attr$ClassName$", ({
...
function $ct_Ljapgolly_scalajs_react_vdom_Attr$Generic__T__($thiz, attrName) {
  $ct_Ljapgolly_scalajs_react_vdom_Attr__T__($thiz, attrName);
  return $thiz;
}
/** @constructor */
...
var $d_Ljapgolly_scalajs_react_vdom_Attr$Generic = new $TypeData().initClass($c_Ljapgolly_scalajs_react_vdom_Attr$Generic, "japgolly.scalajs.react.vdom.Attr$Generic", ({
...
function $c_Ljapgolly_scalajs_react_vdom_Attr$Key$() {
  this.Ljapgolly_scalajs_react_vdom_Attr__f_attrName = null;
  $ct_Ljapgolly_scalajs_react_vdom_Attr__T__(this, "key");
}
...
$c_Ljapgolly_scalajs_react_vdom_Attr$Key$.prototype.$colon$eq__O__F2__Ljapgolly_scalajs_react_vdom_TagMod = (function(a, t) {
  var f = new $c_sjsr_AnonFunction1(((b) => {
    var b$1 = $as_Ljapgolly_scalajs_react_vdom_VdomBuilder(b);
    $n(t).apply__O__O__O($n(b$1).Ljapgolly_scalajs_react_vdom_VdomBuilder$ToRawReactElement__f_setKey, a);
  }));
  return new $c_Ljapgolly_scalajs_react_vdom_TagMod$$anon$3(f);
});
var $d_Ljapgolly_scalajs_react_vdom_Attr$Key$ = new $TypeData().initClass($c_Ljapgolly_scalajs_react_vdom_Attr$Key$, "japgolly.scalajs.react.vdom.Attr$Key$", ({
  Ljapgolly_scalajs_react_vdom_Attr$Key$: 1,
  Ljapgolly_scalajs_react_vdom_Attr: 1
}));
var $n_Ljapgolly_scalajs_react_vdom_Attr$Key$;
function $m_Ljapgolly_scalajs_react_vdom_Attr$Key$() {
  if ((!$n_Ljapgolly_scalajs_react_vdom_Attr$Key$)) {
    $n_Ljapgolly_scalajs_react_vdom_Attr$Key$ = new $c_Ljapgolly_scalajs_react_vdom_Attr$Key$();
  }
  return $n_Ljapgolly_scalajs_react_vdom_Attr$Key$;
}
/** @constructor */
function $c_Ljapgolly_scalajs_react_vdom_Attr$Style$() {
  this.Ljapgolly_scalajs_react_vdom_Attr__f_attrName = null;
  $ct_Ljapgolly_scalajs_react_vdom_Attr__T__(this, "style");
}
$c_Ljapgolly_scalajs_react_vdom_Attr$Style$.prototype = new $h_Ljapgolly_scalajs_react_vdom_Attr();
$c_Ljapgolly_scalajs_react_vdom_Attr$Style$.prototype.constructor = $c_Ljapgolly_scalajs_react_vdom_Attr$Style$;
/** @constructor */
function $h_Ljapgolly_scalajs_react_vdom_Attr$Style$() {
}
$h_Ljapgolly_scalajs_react_vdom_Attr$Style$.prototype = $c_Ljapgolly_scalajs_react_vdom_Attr$Style$.prototype;
$c_Ljapgolly_scalajs_react_vdom_Attr$Style$.prototype.$colon$eq__O__F2__Ljapgolly_scalajs_react_vdom_TagMod = (function(a, t) {
  var f = new $c_sjsr_AnonFunction1(((b) => {
    var b$1 = $as_Ljapgolly_scalajs_react_vdom_VdomBuilder(b);
    $n(t).apply__O__O__O(new $c_sjsr_AnonFunction1(((j) => {
      var this$2 = $n(b$1);
      $f_Ljapgolly_scalajs_react_vdom_VdomBuilder__addStyles__sjs_js_Any__V(this$2, j);
    })), a);
  }));
  return new $c_Ljapgolly_scalajs_react_vdom_TagMod$$anon$3(f);
});
var $d_Ljapgolly_scalajs_react_vdom_Attr$Style$ = new $TypeData().initClass($c_Ljapgolly_scalajs_react_vdom_Attr$Style$, "japgolly.scalajs.react.vdom.Attr$Style$", ({
  Ljapgolly_scalajs_react_vdom_Attr$Style$: 1,
  Ljapgolly_scalajs_react_vdom_Attr: 1
}));
var $n_Ljapgolly_scalajs_react_vdom_Attr$Style$;
function $m_Ljapgolly_scalajs_react_vdom_Attr$Style$() {
  if ((!$n_Ljapgolly_scalajs_react_vdom_Attr$Style$)) {
    $n_Ljapgolly_scalajs_react_vdom_Attr$Style$ = new $c_Ljapgolly_scalajs_react_vdom_Attr$Style$();
  }
  return $n_Ljapgolly_scalajs_react_vdom_Attr$Style$;
}
/** @constructor */
function $c_Ljapgolly_scalajs_react_vdom_Exports$() {
  this.Ljapgolly_scalajs_react_vdom_Exports__f_EmptyVdom = null;
...
function $c_Ljapgolly_scalajs_react_vdom_HtmlTags$() {
  this.Ljapgolly_scalajs_react_vdom_HtmlTags$__f_a$lzy1 = null;
  this.Ljapgolly_scalajs_react_vdom_HtmlTags$__f_abitmap$1 = false;
}
...
$c_Ljapgolly_scalajs_react_vdom_HtmlTags$.prototype.a__Ljapgolly_scalajs_react_vdom_HtmlTags$a$ = (function() {
  if ((!this.Ljapgolly_scalajs_react_vdom_HtmlTags$__f_abitmap$1)) {
    this.Ljapgolly_scalajs_react_vdom_HtmlTags$__f_a$lzy1 = new $c_Ljapgolly_scalajs_react_vdom_HtmlTags$a$(this);
    this.Ljapgolly_scalajs_react_vdom_HtmlTags$__f_abitmap$1 = true;
  }
  return this.Ljapgolly_scalajs_react_vdom_HtmlTags$__f_a$lzy1;
});
...
function $f_Ljapgolly_scalajs_react_vdom_ImplicitsForVdomAttr1__$init$__V($thiz) {
  ...
  $thiz.Ljapgolly_scalajs_react_vdom_PackageBase__f_vdomAttrVtKeyS = $f_Ljapgolly_scalajs_react_vdom_ImplicitsForVdomAttr1__vdomAttrVtKey__F1__F2($thiz, k);
}
function $f_Ljapgolly_scalajs_react_vdom_ImplicitsForVdomAttr1__vdomAttrVtKey__F1__F2($thiz, k) {
  var fn$proxy2 = new $c_sjsr_AnonFunction2(((b, a) => {
    var b$1 = $as_F1(b);
...
function $f_Ljapgolly_scalajs_react_vdom_VdomBuilder$ToJs__$init$__V($thiz) {
  ...
  $thiz.Ljapgolly_scalajs_react_vdom_VdomBuilder$ToRawReactElement__f_addAttr = new $c_sjsr_AnonFunction2(((_$2, _$3) => {
    var _$2$1 = $as_T(_$2);
    var o = $thiz.Ljapgolly_scalajs_react_vdom_VdomBuilder$ToRawReactElement__f_props;
    o[_$2$1] = _$3;
  }));
  $thiz.Ljapgolly_scalajs_react_vdom_VdomBuilder$ToRawReactElement__f_addClassName = new $c_sjsr_AnonFunction1(((n) => {
    var x = $thiz.Ljapgolly_scalajs_react_vdom_VdomBuilder$ToRawReactElement__f_nonEmptyClassName;
    if ((x === (void 0))) {
      var $x_1 = n;
    } else {
      var s = (($dp_toString__T($n(x)) + " ") + n);
      var $x_1 = s;
    }
    $thiz.Ljapgolly_scalajs_react_vdom_VdomBuilder$ToRawReactElement__f_nonEmptyClassName = $x_1;
  }));
  $thiz.Ljapgolly_scalajs_react_vdom_VdomBuilder$ToRawReactElement__f_addEventHandler = new $c_sjsr_AnonFunction2(((k, g) => {
    var k$1 = $as_T(k);
  ...
  $thiz.Ljapgolly_scalajs_react_vdom_VdomBuilder$ToRawReactElement__f_addStyle = new $c_sjsr_AnonFunction2(((_$5, _$6) => {
    var _$5$1 = $as_T(_$5);
    var o$2 = $thiz.Ljapgolly_scalajs_react_vdom_VdomBuilder$ToRawReactElement__f_styles;
    o$2[_$5$1] = _$6;
  }));
  $thiz.Ljapgolly_scalajs_react_vdom_VdomBuilder$ToRawReactElement__f_addStylesObject = new $c_sjsr_AnonFunction1(((o$3) => {
    var this$18 = $n($m_Ljapgolly_scalajs_react_util_JsUtil$().objectIterator__sjs_js_Object__sc_Iterator(o$3));
    var p = new $c_sjsr_AnonFunction1(((x$1) => {
      var x$1$1 = $as_T2(x$1);
      return ((x$1$1 !== null) && ($as_T($n(x$1$1).T2__f__1), $n(x$1$1), true));
    }));
    var this$19 = new $c_sc_Iterator$$anon$6(this$18, p, false);
    while (this$19.hasNext__Z()) {
      var arg1 = this$19.next__O();
      var x$1$2 = $as_T2(arg1);
      matchResult5: {
        if ((x$1$2 !== null)) {
          var k$3 = $as_T($n(x$1$2).T2__f__1);
          var v$1 = $n(x$1$2).T2__f__2;
          $n($thiz.Ljapgolly_scalajs_react_vdom_VdomBuilder$ToRawReactElement__f_addStyle).apply__O__O__O(k$3, v$1);
          break matchResult5;
        }
  ...
  $thiz.Ljapgolly_scalajs_react_vdom_VdomBuilder$ToRawReactElement__f_appendChild = new $c_sjsr_AnonFunction1(((_$7) => {
    $thiz.Ljapgolly_scalajs_react_vdom_VdomBuilder$ToRawReactElement__f_children.push(_$7);
  }));
  $thiz.Ljapgolly_scalajs_react_vdom_VdomBuilder$ToRawReactElement__f_setKey = new $c_sjsr_AnonFunction1(((k$2$1) => {
    $thiz.Ljapgolly_scalajs_react_vdom_VdomBuilder$ToRawReactElement__f_key = k$2$1;
  }));
}
...
function $p_Ljapgolly_scalajs_react_component_JsFn$UnmountedSimple__postRender__Ljapgolly_scalajs_react_facade_React$Component__O($thiz, result) {
  ...
  return $n($thiz.mountRaw__F1()).apply__O__O(result);
}
...
/** @constructor */
function $c_Ljapgolly_scalajs_react_vdom_HtmlAttrs$target$(outer) {
  this.Ljapgolly_scalajs_react_vdom_Attr__f_attrName = null;
  if ((outer === null)) {
    throw new $c_jl_NullPointerException();
  }
  $ct_Ljapgolly_scalajs_react_vdom_Attr__T__(this, "target");
}
$c_Ljapgolly_scalajs_react_vdom_HtmlAttrs$target$.prototype = new $h_Ljapgolly_scalajs_react_vdom_Attr$Generic();
$c_Ljapgolly_scalajs_react_vdom_HtmlAttrs$target$.prototype.constructor = $c_Ljapgolly_scalajs_react_vdom_HtmlAttrs$target$;
/** @constructor */
function $h_Ljapgolly_scalajs_react_vdom_HtmlAttrs$target$() {
}
$h_Ljapgolly_scalajs_react_vdom_HtmlAttrs$target$.prototype = $c_Ljapgolly_scalajs_react_vdom_HtmlAttrs$target$.prototype;
var $d_Ljapgolly_scalajs_react_vdom_HtmlAttrs$target$ = new $TypeData().initClass($c_Ljapgolly_scalajs_react_vdom_HtmlAttrs$target$, "japgolly.scalajs.react.vdom.HtmlAttrs$target$", ({
  Ljapgolly_scalajs_react_vdom_HtmlAttrs$target$: 1,
  Ljapgolly_scalajs_react_vdom_Attr$Generic: 1,
  Ljapgolly_scalajs_react_vdom_Attr: 1
}));
function $f_Ljapgolly_scalajs_react_vdom_ImplicitsForVdomAttr__$init$__V($thiz) {
  ...
  $m_Ljapgolly_scalajs_react_vdom_Attr$ValueType$();
  $thiz.Ljapgolly_scalajs_react_vdom_PackageBase__f_vdomAttrVtJsObject = $m_Ljapgolly_scalajs_react_vdom_Attr$ValueType$().Ljapgolly_scalajs_react_vdom_Attr$ValueType$__f_direct;
}
/** @constructor */
function $c_Ljapgolly_scalajs_react_vdom_VdomArray(rawArray) {
  this.Ljapgolly_scalajs_react_vdom_VdomArray__f_rawArray = null;
  this.Ljapgolly_scalajs_react_vdom_VdomArray__f_rawArray = rawArray;
}
$c_Ljapgolly_scalajs_react_vdom_VdomArray.prototype = new $h_O();
$c_Ljapgolly_scalajs_react_vdom_VdomArray.prototype.constructor = $c_Ljapgolly_scalajs_react_vdom_VdomArray;
/** @constructor */
...
$h_Ljapgolly_scalajs_react_vdom_VdomArray.prototype = $c_Ljapgolly_scalajs_react_vdom_VdomArray.prototype;
$c_Ljapgolly_scalajs_react_vdom_VdomArray.prototype.applyTo__Ljapgolly_scalajs_react_vdom_VdomBuilder__V = (function(b) {
  $n($n(b).Ljapgolly_scalajs_react_vdom_VdomBuilder$ToRawReactElement__f_appendChild).apply__O__O(this.Ljapgolly_scalajs_react_vdom_VdomArray__f_rawArray);
});
$c_Ljapgolly_scalajs_react_vdom_VdomArray.prototype.rawNode__O = (function() {
  return this.Ljapgolly_scalajs_react_vdom_VdomArray__f_rawArray;
});
var $d_Ljapgolly_scalajs_react_vdom_VdomArray = new $TypeData().initClass($c_Ljapgolly_scalajs_react_vdom_VdomArray, "japgolly.scalajs.react.vdom.VdomArray", ({
  Ljapgolly_scalajs_react_vdom_VdomArray: 1,
  Ljapgolly_scalajs_react_vdom_TagMod: 1,
...
function $c_Ljapgolly_scalajs_react_vdom_VdomBuilder$ToRawReactElement() {
  ...
  this.Ljapgolly_scalajs_react_vdom_VdomBuilder$ToRawReactElement__f_addStylesObject = null;
...
function $c_Ljapgolly_scalajs_react_vdom_HtmlAttrAndStyles$() {
  this.Ljapgolly_scalajs_react_vdom_HtmlAttrAndStyles$__f_key = null;
  this.Ljapgolly_scalajs_react_vdom_HtmlAttrAndStyles$__f_target$lzy1 = null;
  this.Ljapgolly_scalajs_react_vdom_HtmlAttrAndStyles$__f_targetbitmap$1 = false;
...
$c_Ljapgolly_scalajs_react_vdom_HtmlAttrAndStyles$.prototype.target__Ljapgolly_scalajs_react_vdom_HtmlAttrs$target$ = (function() {
  if ((!this.Ljapgolly_scalajs_react_vdom_HtmlAttrAndStyles$__f_targetbitmap$1)) {
    this.Ljapgolly_scalajs_react_vdom_HtmlAttrAndStyles$__f_target$lzy1 = new $c_Ljapgolly_scalajs_react_vdom_HtmlAttrs$target$(this);
    this.Ljapgolly_scalajs_react_vdom_HtmlAttrAndStyles$__f_targetbitmap$1 = true;
  }
  return this.Ljapgolly_scalajs_react_vdom_HtmlAttrAndStyles$__f_target$lzy1;
});
...
function $ct_Ljapgolly_scalajs_react_vdom_TagOf__T__sci_List__($thiz, tag, modifiers) {
  $thiz.Ljapgolly_scalajs_react_vdom_TagOf__f_tag = tag;
  $thiz.Ljapgolly_scalajs_react_vdom_TagOf__f_modifiers = modifiers;
  return $thiz;
}
/** @constructor */
...
$c_Ljapgolly_scalajs_react_vdom_TagOf.prototype.apply__sci_Seq__Ljapgolly_scalajs_react_vdom_TagOf = (function(xs) {
  var this$1 = $n(this.Ljapgolly_scalajs_react_vdom_TagOf__f_modifiers);
  var modifiers$1 = new $c_sci_$colon$colon(xs, this$1);
  var tag$1 = this.Ljapgolly_scalajs_react_vdom_TagOf__f_tag;
  return $ct_Ljapgolly_scalajs_react_vdom_TagOf__T__sci_List__(new $c_Ljapgolly_scalajs_react_vdom_TagOf(), tag$1, modifiers$1);
});
$c_Ljapgolly_scalajs_react_vdom_TagOf.prototype.rawElement__Ljapgolly_scalajs_react_facade_React$Element = (function() {
  if ((!this.Ljapgolly_scalajs_react_vdom_TagOf__f_rawElementbitmap$1)) {
    ...
    while ((j > 0)) {
      j = (((-1) + j) | 0);
      $n($as_sc_IterableOnceOps(arr[j])).foreach__F1__V(new $c_sjsr_AnonFunction1(((b) => ((_$1) => {
...
$c_Ljapgolly_scalajs_react_vdom_VdomElement$$anon$1.prototype.applyTo__Ljapgolly_scalajs_react_vdom_VdomBuilder__V = (function(b) {
  $n($n(b).Ljapgolly_scalajs_react_vdom_VdomBuilder$ToRawReactElement__f_appendChild).apply__O__O(this.Ljapgolly_scalajs_react_vdom_VdomElement$$anon$1__f_n$1);
});
$c_Ljapgolly_scalajs_react_vdom_VdomElement$$anon$1.prototype.rawNode__O = (function() {
  return this.Ljapgolly_scalajs_react_vdom_VdomElement$$anon$1__f_n$1;
});
var $d_Ljapgolly_scalajs_react_vdom_VdomElement$$anon$1 = new $TypeData().initClass($c_Ljapgolly_scalajs_react_vdom_VdomElement$$anon$1, "japgolly.scalajs.react.vdom.VdomElement$$anon$1", ({
...
/** @constructor */
function $c_Llanding_Main$Feature(title, desc) {
  this.Llanding_Main$Feature__f_title = null;
  this.Llanding_Main$Feature__f_desc = null;
  this.Llanding_Main$Feature__f_title = title;
  this.Llanding_Main$Feature__f_desc = desc;
}
$c_Llanding_Main$Feature.prototype = new $h_O();
$c_Llanding_Main$Feature.prototype.constructor = $c_Llanding_Main$Feature;
/** @constructor */
function $h_Llanding_Main$Feature() {
}
$h_Llanding_Main$Feature.prototype = $c_Llanding_Main$Feature.prototype;
$c_Llanding_Main$Feature.prototype.productIterator__sc_Iterator = (function() {
  return new $c_s_Product$$anon$1(this);
});
$c_Llanding_Main$Feature.prototype.hashCode__I = (function() {
  var this$2 = $m_s_util_hashing_MurmurHash3$();
  return this$2.productHash__s_Product__I__Z__I(this, (-889275714), false);
});
$c_Llanding_Main$Feature.prototype.equals__O__Z = (function(x$0) {
  if ((this === x$0)) {
    return true;
  } else if ((x$0 instanceof $c_Llanding_Main$Feature)) {
    var x$0$2 = $as_Llanding_Main$Feature(x$0);
    return ((this.Llanding_Main$Feature__f_title === $n(x$0$2).Llanding_Main$Feature__f_title) && (this.Llanding_Main$Feature__f_desc === $n(x$0$2).Llanding_Main$Feature__f_desc));
  } else {
    return false;
  }
});
$c_Llanding_Main$Feature.prototype.toString__T = (function() {
  return $m_sr_ScalaRunTime$()._toString__s_Product__T(this);
});
$c_Llanding_Main$Feature.prototype.productArity__I = (function() {
  return 2;
});
$c_Llanding_Main$Feature.prototype.productPrefix__T = (function() {
  return "Feature";
});
$c_Llanding_Main$Feature.prototype.productElement__I__O = (function(n) {
  if ((n === 0)) {
    return this.Llanding_Main$Feature__f_title;
  }
  if ((n === 1)) {
    return this.Llanding_Main$Feature__f_desc;
  }
  throw $ct_jl_IndexOutOfBoundsException__T__(new $c_jl_IndexOutOfBoundsException(), ("" + n));
});
function $as_Llanding_Main$Feature(obj) {
  return (((obj instanceof $c_Llanding_Main$Feature) || (obj === null)) ? obj : $throwClassCastException(obj, "landing.Main$Feature"));
}
function $isArrayOf_Llanding_Main$Feature(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Llanding_Main$Feature)));
}
function $asArrayOf_Llanding_Main$Feature(obj, depth) {
  return (($isArrayOf_Llanding_Main$Feature(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Llanding.Main$Feature;", depth));
}
var $d_Llanding_Main$Feature = new $TypeData().initClass($c_Llanding_Main$Feature, "landing.Main$Feature", ({
  Llanding_Main$Feature: 1,
  s_Equals: 1,
  s_Product: 1,
  Ljava_io_Serializable: 1
}));
...
/** @constructor */
function $c_Ljapgolly_scalajs_react_vdom_HtmlTags$a$(outer) {
  this.Ljapgolly_scalajs_react_vdom_TagOf__f_tag = null;
  this.Ljapgolly_scalajs_react_vdom_TagOf__f_modifiers = null;
  this.Ljapgolly_scalajs_react_vdom_TagOf__f_rawElement$lzy1 = null;
  this.Ljapgolly_scalajs_react_vdom_TagOf__f_rawElementbitmap$1 = false;
  ...
  $ct_Ljapgolly_scalajs_react_vdom_TagOf__T__sci_List__(this, "a", $m_sci_Nil$());
}
...
var $d_Ljapgolly_scalajs_react_vdom_HtmlTags$a$ = new $TypeData().initClass($c_Ljapgolly_scalajs_react_vdom_HtmlTags$a$, "japgolly.scalajs.react.vdom.HtmlTags$a$", ({
...
function $c_Ljapgolly_scalajs_react_component_JsFn$$anon$4(from$1, mp$1, mm$1) {
  ...
  var this$1 = $n(from$1);
  this.Ljapgolly_scalajs_react_component_JsFn$$anon$4__f_raw = this$1.raw__Ljapgolly_scalajs_react_facade_React$ComponentElement();
...
$c_Ljapgolly_scalajs_react_component_JsFn$$anon$4.prototype.mapUnmountedProps__F1__Ljapgolly_scalajs_react_component_JsFn$UnmountedWithRoot = (function(f) {
  ...
  var mp = $n(f).compose__F1__F1(this.Ljapgolly_scalajs_react_component_JsFn$$anon$4__f_mp$1);
...
function $c_Ljapgolly_scalajs_react_vdom_PackageBase() {
  ...
  this.Ljapgolly_scalajs_react_vdom_Exports__f_HtmlTagOf = null;
  this.Ljapgolly_scalajs_react_vdom_Exports__f_VdomAttr = null;
  this.Ljapgolly_scalajs_react_vdom_PackageBase__f_vdomAttrVtKeyS = null;
  this.Ljapgolly_scalajs_react_vdom_PackageBase__f_vdomAttrVtString = null;
  this.Ljapgolly_scalajs_react_vdom_PackageBase__f_vdomAttrVtJsObject = null;
}
...
$L0 = new $c_RTLong(0, 0);
$d_J.zero = $L0;
$s_Llanding_Main__main__AT__V(new ($d_T.getArrayOf().constr)([]));
//# sourceMappingURL=aathu-landing-fastopt.js.map
